 ...
 * @return string
 */
function write($phpWord, $filename, $writers,$folder)
...

{
  ...
  //print_r($filename);
    ...
    foreach ($writers as $format => $extension) {
        ...
        if (null !== $extension) {
            $targetFile = __DIR__ . "/results/{$folder}/{$filename}.{$extension}";
    ...
    $result .= getEndingNotes($writers, $filename ,$folder);
 ...
 * @return string
 */
function getEndingNotes($writers, $filename,$folder)
{
    $result = '';
    ...
    if (CLI) {
        ...
        if (!IS_INDEX) {
            ...
            foreach ($types as $type) {
                if (!is_null($type)) {
                    $resultFile = 'results/'.$folder .'/'. $filename . '.' . $type;
                    if (file_exists($resultFile)) {
                        $result .= "<a href='{$resultFile}' class='btn btn-primary'>Download</a> ";
                    }
                }
            }

            $result .= "<a href='#' onclick='goBack()' class='btn btn-success'>Back</a> ";
            $result .= "<a href='#' id='{$folder}' class='btn btn-success delete'>Delete Files</a> ";
            $result .= '</p>';
...
<div class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">NabhBuddy</a>
