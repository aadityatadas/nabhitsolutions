 ...
 foreach ($result as $key => $row) {
   ...
   // [patient_name_present] => [medic_caps_legible] => [dose] => [quantity] => [date_prescription] => [high_risk_medicn_verified] => [sign_of_doc] =>
     ...
     //echo count($result);
       ...
       $json['pre_by_auth_person'][] =  (int)$pre_by_auth_person_per;
       $json['drug_name_clear'][] =  (int)$drug_name_clear_per;
       $json['dose_corret'][] =  (int)$dose_corret_per;
       $json['time_prescription'][] =  (int)$time_prescription_per;
       $json['sign_of_auth'][] =  (int)$sign_of_auth_per;
