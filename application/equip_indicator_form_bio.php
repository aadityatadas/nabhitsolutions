...
<script type="text/javascript">
	...
	function ()
	{
	$('#eqp').load('eqp_countNew_bio.php').fadeIn("slow");
				...
				<div class="col-lg-12">
                    <div class="panel panel-info">
                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_eqp_indic_bio LEFT JOIN tbl_eqp_mast_bio ON tbl_eqp_mast_bio.eqpid = tbl_eqp_indic_bio.eqpid WHERE year(eqp_brkdwn_date) = '$yr' ";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_eqp_indic_bio LEFT JOIN tbl_eqp_mast_bio ON tbl_eqp_mast_bio.eqpid = tbl_eqp_indic_bio.eqpid  WHERE eqp_make!='' AND year(eqp_brkdwn_date) = '$yr' ";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_eqp_indic_bio LEFT JOIN tbl_eqp_mast_bio ON tbl_eqp_mast_bio.eqpid = tbl_eqp_indic_bio.eqpid  WHERE eqp_make=''  AND year(eqp_brkdwn_date) = '$yr'";
							...
							<div id="adm">
								<form method="post" id="user_form" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-7">
												<select type="text" onchange="get_select_val(this.value);" name="mo1" id="mo1" class="form-control" required />
													<?php include"eqp_mast_list_bio.php";?>
												</select>
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Date & Time of Complain Attended</label>
											<div class="col-lg-2">
												<input type="text" autocomplete="off" name="mo32" id="mo32" placeholder="yyyy-mm-dd" class="form-control" />
											</div>
											<div class="col-lg-2">
												<input type="time" name="mo33" id="mo33" class="form-control" />
											</div>
										</div>
										<div class="col-lg-12">
                        ...
                        <div class="box" id="bx2">
							...
							<form method="post" action = "../excel/BMR/export.php" class="panel-heading">
							<div class="col-lg-12">
...
document.getElementById('mo25').value=stk[20];
	...
	$(document).ready(function() {
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				url:"fetch_single_eqp_form_bio.php",
				method:"POST",
