...
<p style="page-break-before: always"></p>
 <h2 align="center"><u>Transportation & Handling of Specimens</u></h2>  
...
<tr>
  ...
  <th width="25%"><strong>Transportation & Handling of Specimens</strong></th>
  <th width="20%">Yes</th>
  <th width="20%">No</th>
  <th width="20%">NA</th>
      ...
      function drawChart() {
       ...
       var jsonData = $.ajax({
        ...
        success: function(jsonData)
          {
             var options = {
          title : 'Transportation & Handling of Specimens Audit',
          curveType: 'function',
              dataOpacity: 0.5,
              is3D: false,
              bar: {groupWidth: "40%"},
