<?php
	...
	{	
		...
		{
			$qry=mysqli_query($connect,"SELECT eqp_lic_img_doc FROM tbl_eqp_indic WHERE eqp_id = '$cid'")or die(mysqli_error($connect));
			...
			$qry2 = "UPDATE tbl_eqp_indic SET eqp_lic_img_doc = '$imagesx' WHERE eqp_id = '$cid'";
