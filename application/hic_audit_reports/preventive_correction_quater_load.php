...
<script  type="text/javascript" >
	function saveCPReport(id,name){
		...
		//var array = name.split("_");
	     ...
	     $.ajax({
				url:"hic_audit_reports/load_old_quater_report.php",
				method:"POST",
...
function myFunction1(item, index) {
   ...
   if(index!=100){
   	var c=Number(index) + Number(1);
   additionalRows='<tr id="row2'+index+'"><td width="2%" class="paymentsno1">'+c+'</td><td><textarea type="text" col="2" name="preventive_action['+index+']" id="preventive-action'+index+'" class="form-control" >'+item+'</textarea></td><td width="5%"><span  class="label label-danger" onclick="return removerow2('+index+');">Remove</span></td></tr>';
    ...
    $('#prevebody').append(additionalRows);
		...
		var x = document.getElementById("aname"); 
          var x1= name.capitalize();
          x.innerHTML =x1; 
          $('#report_name_d').val(x1);
...
<script  type="text/javascript" >
	...
	$(document).on('submit', '#report_form', function(event){
			event.preventDefault();
					...
					$.ajax({
						url:"hic_audit_reports/save_quaterly_audit_report.php",
						method:'POST',
...
function removerow1(id){
  ...
  function addrow2(){
    ...
    additionalRows='<tr id="row2'+count+'"><td width="2%" class="paymentsno1">1</td><td><textarea type="text" col="2" name="preventive_action['+count+']" id="preventive-action'+count+'" class="form-control" ></textarea></td><td width="5%"><span  class="label label-danger" onclick="return removerow2('+count+');">Remove</span></td></tr>';
