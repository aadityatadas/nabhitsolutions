    ...
    <div id="wrapper">
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-12"  >
					<a href="dashboard-mrdoffice.php"><button type="button" class="btn btn-info pull-left" style="font-size: 20px;">Dashboard</button></a>
				</div>
                <div class="col-lg-12">
					<br />
				</div>
							...
							<div id="order-table" class="table-responsive">
								<div class="col-lg-12">
									<table width="100%" style="font-size:14px; " class="table-bordered" >
										<?php include"form_ind_det_mrd.php";?>
									</table>
								</div>
							</div>
						</div>
