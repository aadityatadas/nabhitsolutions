...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
         <!-- <rect x="0" y="0" width="460" height="200" stroke="none" stroke-width="0" fill="#ffffff"></rect>
        <style type="text/css">
        	.rect{
        		width:500px;
        	}
					...
					<table cellspacing="0" cellpadding="0" border="0" width="600px" >
						...
						<tr>
							<td style="vertical-align: top;">
								<div id="line_chart1" style="height:200px;margin: 20px;"></div>

								
							</td>
							<td style="vertical-align: top;">
								<div id="line_chart2" style="height:20px;margin: 20px;"></div>
							</td>
						</tr>
					</table>
