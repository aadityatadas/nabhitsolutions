...
foreach($result as $row)
{
	$centid = $row["hrid"];
	$sub_array = array();
	$sub_array[] = '<a style="cursor:pointer;" title="Click here to edit" id="'.$row["hrid"].'" class="update" ><i style="color:#2b6a9f;" class="fa fa-edit fa-fw"></i></a>&nbsp;&nbsp;<a style="cursor:pointer;" title="Click here to delete" id="'.$row["hrid"].'" class="delete" ><i style="color:red;" class="fa fa-trash-o fa-fw"></i></a>';
