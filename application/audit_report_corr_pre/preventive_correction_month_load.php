...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog rptr1" role="document">
    <div class="modal-content">
      <div class="modal-header rpt">
...
<script  type="text/javascript" >
	function saveCPReport(id,name){
		...
		var array = name.split("_");
	     ...
	     $.ajax({
				url:"audit_report_corr_pre/load_old_month_report.php",
				method:"POST",
...
function myFunction1(item, index) {
   ...
   additionalRows='<tr id="row1'+index+'"><td width="2%" class="paymentsno1">'+c+'</td><td><textarea type="text" col="2" name="preventive_action['+index+']" id="preventive-action'+index+'" class="form-control" >'+item+'</textarea></td><td width="5%"><span  class="label label-danger" onclick="return removerow2('+index+');">Remove</span></td></tr>';
    ...
    $('#prevebody').append(additionalRows);
		...
		var x = document.getElementById("aname"); 
          //var x1= array[0].capitalize()+ ' ' +array[1].capitalize();
          ///x.innerHTML =x1; 
          $('#report_name_d').val('Audit ');
...
<script  type="text/javascript" >
	...
	$(document).on('submit', '#report_form', function(event){
			event.preventDefault();
					...
					$.ajax({
						url:"audit_report_corr_pre/save_monthly_audit_report.php",
						method:'POST',
    ...
    additionalRows='<tr id="row'+count+'"><td width="2%" class="paymentsno">1</td><td><textarea type="text" col="2" name="corrective_action['+count+']" id="corrective-action'+count+'" class="form-control" ></textarea></td><td width="5%"><span  class="label label-danger" onclick="return removerow1('+count+');">Remove</span></td></tr>';
...
function removerow1(id){
  ...
  function addrow2(){
    ...
    additionalRows='<tr id="row1'+count+'"><td width="2%" class="paymentsno1">1</td><td><textarea type="text" col="2" name="preventive_action['+count+']" id="preventive-action'+count+'" class="form-control" ></textarea></td><td width="5%"><span  class="label label-danger" onclick="return removerow2('+count+');">Remove</span></td></tr>';
