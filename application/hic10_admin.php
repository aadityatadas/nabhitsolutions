<?php
	...
	$day = isWeekend($dat);
	//$dateVal = date('d/m/Y');
	$query = "SELECT * FROM tbl_audit_hh10 where dateVal = '$dat'";
							...
							<div id="adm">
								<form method="post" id="user_form" enctype="multipart/form-data">
									<div class="form-group">
										<div class="col-lg-12">
											...
											<div class="col-lg-4" id="sr">
												<input type="text" name="sr_no" id="sr_no" class="form-control" value="<?= $cd ?>" readonly />
											</div>
									...
									<div class="col-lg-12">
										...
										<div class="col-lg-2">
											<input type="text" name="dateVal" id="dateVal" value="<?= $dat ?>"  class="form-control" readonly />
                        ...
                        <div class="box" id="bx2">
							<div class="panel-body">
								...
								<div class="col-lg-12">
								 ...
								 <div class="col-lg-12" style="margin-top:10px;text-align:center;border: 1px solid;padding: 10px;box-shadow: 5px 10px #888888;">
								<form method="post" action="audit_hh/hic10Pdf.php"  target="print_popup"  onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
									<div class="panel-heading">
										<div class="col-lg-2" style="color: black;">
											From
										</div>
										<div class="col-lg-3">
											<input type="text" name="fdate" class="form-control" placeholder="From Date" id="fdatep" value="<?php echo $frdt;?>">
										</div>
										<label class="col-lg-1">To</label>
										<div class="col-lg-3">
											<input type="text" name="tdate" class="form-control" placeholder="To Date" id="tdatep" value="<?php echo $todt;?>">
										</div>
										<input type="hidden" name="tblname" value="tbl_audit_hh10">
							 ...
							 <div class="col-lg-12" style="margin-top:10px;text-align:center;border: 1px solid;padding: 10px;box-shadow: 5px 10px #888888;">
								<form method="post" action="audit_hh/hic10Excel.php" >
									<div class="panel-heading">
										<div class="col-lg-2" style="color: black;">
											From
										</div>
										<div class="col-lg-3">
											<input type="text" name="fdate" class="form-control" placeholder="From Date" id="fdatee" value="<?php echo $frdt;?>">
										</div>
										<label class="col-lg-1">To</label>
										<div class="col-lg-3">
											<input type="text" name="tdate" class="form-control" placeholder="To Date" id="tdatee" value="<?php echo $todt;?>">
										</div>
										<input type="hidden" name="tblname" value="tbl_audit_hh10">
										
										<div class="col-lg-1">
											<input type="submit" style="color: white;"  name="export" class="btn btn-success" value="Report(Excel)" />
										</div>
									</div>
								</form>
							</div>
                ...
                <div class="form-group">
					<div class="col-lg-12">
						<div class="col-lg-8" style="padding-left:0;">
							...
							<div class="col-lg-4">
								<button type="button" name="search" id="search" class="btn btn-primary btn-sm" onclick="graph_chart();" >SEARCH</button>
							</div>
						</div>
					</div>
				</div>
				...
				<!-- <div class="form-group">
					<div class="col-lg-12">
						<div class="col-lg-8" style="padding-left:0;">
							...
							<div class="col-lg-4">
								<button  style="color: white;font-weight: bold;" type="button" name="search" id="search" class="btn btn-primary btn-sm" onclick="graph_chart();" >SEARCH</button>
							</div>
						</div>
					</div>
				</div> --> 
...
<script type="text/javascript">	
		...
		function line_chart() 
		{
			...
			if(frdate != '' && todate != '')
			{
				// chart one
				var jsonData = $.ajax({
				url: 'audit_hh/chart_audit_10.php',
				dataType:"json",
				method:"POST",
				async: false,
				data:{qut:qut,tbl:tbl,frdate:frdate,todate:todate},
				success: function(jsonData)
					{
						var options = 
						{
							title:'Morning (6:00 to 12:00) Shift Audit Details',
							legend: '',
				...
				success: function(jsonData)
					{
						var options = 
						{
							title:'Afternoon (12:00 to 18:00) Shift Audit Details',
							legend: '',
							hAxis: { minValue: 0, maxValue: 10 },
							//curveType: 'function',
							pointSize: 7,
				...
				success: function(jsonData)
					{
						var options = 
						{
							title:'Night (18:00 to 24:00) Shift Audit Details',
							legend: '',
							hAxis: { minValue: 0, maxValue: 10 },
							//curveType: 'function',
							pointSize: 7,
				...
				success: function(jsonData)
					{
						var options = 
						{
							title:'Night (24:00 to 6:00) Shift Audit Details',
							legend: '',
							hAxis: { minValue: 0, maxValue: 10 },
							//curveType: 'function',
							pointSize: 7,
