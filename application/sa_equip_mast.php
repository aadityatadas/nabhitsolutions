				...
				<div class="col-lg-12">
                    <div class="panel panel-info">
                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_eqp_mast WHERE year(eqp_dtpur) = '$yr' ";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_eqp_mast WHERE eqp_make!='' AND year(eqp_dtpur) = '$yr' ";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_eqp_mast WHERE eqp_make='' AND year(eqp_dtpur) = '$yr'";
                        ...
                        <div class="box" id="bx2">
							...
							<form method="post" action="../excel/EM/export.php" class="panel-heading">
