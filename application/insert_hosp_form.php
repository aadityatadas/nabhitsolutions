...
if(isset($_POST["operation"]))
{
	if($_POST["operation"] == "Add")
	{
		...
		$bld_id = getid('tbl_blood_fusion' , 'bld_id' ,$connect);
		$sq2 = "INSERT INTO tbl_blood_fusion(bld_id,huf_id, bld_prdreq, bld_nounit, bld_dtreq, bld_tmreq, bld_bankname, bld_ordby, bld_dtrec, bld_norec, bld_tmrec, bld_tat, bld_recby, bld_notrfus, bld_trfusreact, bld_waste, bld_waste_det, bld_recd)
		VALUES('$bld_id','$cid','','','','','','','','','','','','','','','','')";
		mysqli_query($connect,$sq2);
    $care_id = getid('tbl_care_evt' , 'care_id' ,$connect);
		$sq3 = "INSERT INTO tbl_care_evt(care_id,huf_id, care_dtpli, care_tmpli, care_vipsc, care_signsymp, care_signsymp_det, care_signsymp_th, care_signsymp_th_det, care_bradsc, care_signsyp_bed, care_signsyp_bed_det, care_mor_sc, care_incd_ptfall, care_incd_ptfall_det, care_iardl, care_iardl_det, care_injtpt, care_injtpt_det, care_recd)
		VALUES('$care_id','','','','','','','','','','','','','','','','','','')";


		
		mysqli_query($connect,$sq3);
		$medi_id = getid('tbl_medi_indi' , 'medi_id' ,$connect);
		$sq4 = "INSERT INTO tbl_medi_indi(medi_id, medi_mrdav, medi_mrdfile, medi_mrddissum, medi_mrdicd, medi_mrdimpcons, medi_mediord, medi_handsheet_dr, medi_handsheet_nur, medi_planofcare, medi_mrd_screen, medi_mrd_nur_careplan, medi_recd)
		VALUES('$medi_id','$cid','','','','','','','','','','','','')";
