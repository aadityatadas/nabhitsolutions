...
<script type="text/javascript">
	...
	function ()
	{
	$('#vent').load('radio_ipd_count.php').fadeIn("slow");
				...
				<div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="padding:7px;height: 140px;">
                           Radiology Indicator Form (IPD) &nbsp;

                           <span style="box-shadow: 0 0 3px 1px rgba(0,0,0,.35);color: #fff;font-weight:bold;margin-right: 10px;" onclick="myFunction()" class="btn btn-info pull-right"><i class="fa fa-print"></i> Print</span>
                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_radio_ipd WHERE year(date_of_rep_gen) = '$yr'";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_radio_ipd  WHERE radio_invst!='' AND year(date_of_rep_gen) = '$yr'";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_radio_ipd WHERE radio_invst=''AND year(date_of_rep_gen) = '$yr'";
...
<br>
     <div id="newDatatoSave" >
		...
		<input type="hidden" name="radio_ipd_id_or" id="radio_ipd_id_or" />										
                        ...
                        <div class="box" id="bx2">
							...
							<div class="col-lg-12">
								<div class="panel panel-default">
									...
									<form method="post" action="../excel/RAD-IPD/export.php" class="panel-heading">
				...
				<div class="form-group">
					<div class="col-lg-12">
						<div class="col-lg-8" style="padding-left:0;">
							...
							<div class="col-lg-4">
								<button style="color:white;font-weight:bold;padding-bottom:15px;" type="button" name="search" id="search" class="btn btn-info btn-sm" onclick="line_chart()" >SEARCH</button>
							</div>
						</div>
					</div>
				</div>
...
<script>	
	$(document).ready(function() {
		...
		var dataTable = $('#dataTables-example').DataTable({
			...
			"order":[],
			"ajax":{
				url:"fetch_all_radio_ipd_form.php",
				type:"POST"
			},
			"columnDefs":[
				{
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
			url:"fetch_single_radio_ipd_form.php",
				method:"POST",
				...
				{  
					...
					$('#radio_ipd_id_or').val(data.radio_ipd_id);
...
html +='<div class="col-lg-12"><label class="col-lg-4">Name of LAB Personnel</label><div class="col-lg-7"><input type="text" autocomplete="off" name="Remarksold[]" id="Remarksold'+i+'" placeholder="name of LAB personnel" class="form-control" value="'+data.remarks_old[i]+'" readonly /></div></div>';
          html +='<div class="col-lg-4"></div><div class="col-lg-2"><button type="button" name="edit" id="'+data.radio_ipd_extra_id[i]+'"  class="btn btn-info edit_data">Edit Record No. '+j+'</button></div></div>';
					...
					success: function(jsonData)
						{
							var options = 
							{
								title:'Radiology Indicator for IPD ',
								legend: '',
...
html +='<div class="col-lg-12"><label class="col-lg-4">Critical Result If Any</label><div class="col-lg-7"><select type="text" name="CriticalResultnew[]" id="CriticalResultnew'+divcount+'" class="form-control"><option value="">Select</option><option value="Yes">Yes</option><option value="No">No</option></select></div></div>';
...
<div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title panel panel-info"> <div class="panel-heading" style="padding:7px;">Radiology Indicator Form Edit </div></h4>  
			...
			<div class="col-lg-12">
                    ...
                    <input type="hidden" name="user_idEdit" id="user_idEdit" />
                     <input type="hidden" name="radio_ipd_extra_id" id="radio_ipd_extra_id" />
 ...
 <script type="text/javascript">
 	...
 	$(document).on('click', '.edit_data', function(){ 
            ...
            var radio_ipd_extra_id = $(this).attr("id");
            var action = "view"; 
           
            
           $.ajax({  
                url:"fetch_single_radio_ipd_form_edit.php",  
                method:"POST",  
                data:{radio_ipd_extra_id:radio_ipd_extra_id,action:action},  
                dataType:"json",  
                success:function(data){ 
            ...
            $('#radio_invstEdit').val(data.radio_invstEdit);
					...
					$('#radio_ipd_extra_id').val(data.radio_ipd_extra_id); 

                     $('#user_idEdit').val(data.tbl_radio_lpd_id); 
