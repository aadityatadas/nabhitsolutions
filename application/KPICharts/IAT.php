...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_huf WHERE year(huf_dadm) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_huf WHERE (int_tottm!=''AND int_tottm!='0') AND  year(huf_dadm) = '$yr' ";
                                $rescomps = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomps);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp= "SELECT COUNT(*) as notcomp FROM tbl_huf WHERE (int_tottm=' ' OR int_tottm='0')AND  year(huf_dadm) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartIAT"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Intial Assessment Time'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartIAT', 'clicknode', {
