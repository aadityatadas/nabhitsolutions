...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_eqp_indic_bio WHERE year(eqp_brkdwn_date) = '$yr' ";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_eqp_indic_bio LEFT JOIN tbl_eqp_mast_bio ON tbl_eqp_mast_bio.eqpid = tbl_eqp_indic_bio.eqpid  WHERE eqp_make!='' AND year(eqp_brkdwn_date) = '$yr' ";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_eqp_indic_bio LEFT JOIN tbl_eqp_mast_bio ON tbl_eqp_mast_bio.eqpid = tbl_eqp_indic_bio.eqpid  WHERE eqp_make=''  AND year(eqp_brkdwn_date) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartBMR"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Bio Maintenance Register'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartBMR', 'clicknode', {
