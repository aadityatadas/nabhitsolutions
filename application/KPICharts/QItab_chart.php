...
<?php echo $total;?>        
    ...
    <div class="col-md-4"><?php echo $notcomp;?></div>
                                         ...
                                         <div id="myChartQI"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  ...
  <script>
    ...
    var myConfig = {
      type: "pie",
      title: {
        text: '<span>Performance Of Indicator</span>'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartQI', 'clicknode', {
