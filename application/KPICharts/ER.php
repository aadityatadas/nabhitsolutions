...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_emrgncy_register_ipd WHERE year(date_of_patient_arrvl_at_emrgncy) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_emrgncy_register_ipd WHERE (time_taken_for_initl_assmnt!='' AND time_taken_for_initl_assmnt!='00:00') AND  year(date_of_patient_arrvl_at_emrgncy) = '$yr' ";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp= "SELECT COUNT(*) as notcomp  FROM tbl_emrgncy_register_ipd  WHERE (time_taken_for_initl_assmnt='' OR time_taken_for_initl_assmnt='00:00' )AND  year(date_of_patient_arrvl_at_emrgncy) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartER"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Emergency Register Form'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartER', 'clicknode', {
