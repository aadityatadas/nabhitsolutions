...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM  tbl_medi_indi LEFT JOIN tbl_huf ON tbl_huf.huf_id= tbl_medi_indi.medi_id WHERE year(huf_dadm) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM  tbl_medi_indi LEFT JOIN tbl_huf ON tbl_huf.huf_id= tbl_medi_indi.medi_id   WHERE  (medi_mrdav='Available' OR medi_mrdav='Missing') AND year(huf_dadm) = '$yr'";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_medi_indi LEFT JOIN tbl_huf ON tbl_huf.huf_id= tbl_medi_indi.medi_id  WHERE  medi_mrdav='' AND year(huf_dadm) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartMRI"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Medical Records Indicator Form'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartMRI', 'clicknode', {
