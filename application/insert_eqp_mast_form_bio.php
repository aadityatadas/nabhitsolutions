...
if(isset($_POST["operation"]))
{
	...
	{
		$qry = "SELECT eqpid FROM tbl_eqp_mast_bio ORDER BY eqpid DESC";
		...
		$statement = $connection->prepare("
			INSERT INTO tbl_eqp_mast_bio (eqpid, eqp_name, eqp_type, eqp_idno, eqp_srno, eqp_model, eqp_make, eqp_dtpur, eqp_dtins, eqp_wty1, eqp_wty2, eqp_amc1 ,eqp_amc2 ,eqp_psch1 ,eqp_psch2 ,eqp_psch3 ,eqp_psch4 ,eqp_csch1 ,eqp_csch2, eqp_recd , eqp_lic,eqp_lic_frm,eqp_lic_to) 
