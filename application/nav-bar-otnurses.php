                      ...
                      <a href="dashboard.php"><i class="fa fa-home fa-fw"></i><b style="color:#0066cc;">  Medical Records Indicator</b> </a>
						...
						<li>
                         ...
                         <li style="border-bottom: 0px; ">
                            <a href="#"style="color:#999; "><i class="fa fa-home fa-fw"></i> OT  Register</b> </a>
                        </li>

					    <li style="border-bottom: 0px; ">
                            <a href="sentinel_event_form2.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Sentinel Event - Surgical and &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Anesthetia Events</a>
                        </li>
						...
						<li>
						 ...
						 <li style="border-bottom: 0px; ">
                            <a href="#" style="padding-left:18px; color:#999;"><i class="fa fa-database fa-fw"></i> Backup Database</a>
                        </li>
