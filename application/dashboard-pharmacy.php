            ...
            <ul class="list" >
               ...
               <!--  <li><a href="admin-kpi.php"><i class="zmdi zmdi-home"></i><span>K.P.I. - Front Office</span></a></li> -->                                               
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-o"></i><span style="color: #eee; font-size: 13.5px;">Training</span> </a>
                    <ul class="ml-menu">
                        <li><a href="#" style="color: #eee; font-size: 13.5px;">Schedule 1</a></li><br>
                        <li><a href="#" style="color: #eee; font-size: 13.5px;">Schedule 2</a></li><br>                       
                        <li><a href="#" style="color: #eee; font-size: 13.5px;">Schedule 3</a></li><br>
                         
                    </ul>
                </li>

                <li><a href="javascript:void(0);"><i class="zmdi zmdi-file-text"></i><span style="color: #eee; font-size: 13.5px;">Documentation</span> </a>
