...
<li>
						...
						<li>
                         ...
                         <li style="border-bottom: 0px; ">
                            <a href="dashboard-engin.php" style="color:#999; "><i class="fa fa-home fa-fw"></i> <b> Equipement  Related </b> </a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="equip_mast1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Equipement Master</a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="equip_indicator_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Equipement Indicator</a>
                        </li>
