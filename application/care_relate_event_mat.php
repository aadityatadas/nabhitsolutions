                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM  tbl_care_evt WHERE year(care_dtpli) = '$yr' ";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM  tbl_care_evt   WHERE  (care_tmpli!='' AND care_tmpli!='00:00') AND year(care_dtpli) = '$yr' ";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM  tbl_care_evt   WHERE (care_tmpli=' ' OR care_tmpli='00:00')AND year(care_dtpli) = '$yr' ";
...
html += '<div class="col-lg-12"><label class="col-lg-4">Injury To Patient</label><div class="col-lg-2"><select type="text" name="mo16old[]" id="mo16old'+i+'" class="form-control" disabled><option value="'+data.mo16_old[i]+'">'+data.mo16_old[i]+'</option></select></div><div class="col-lg-6"><input type="text" name="mo17old[]" id="mo17old'+i+'" placeholder="Enter Corrective Action"class="form-control" value="'+data.mo17_old[i]+'" readonly/></div></div>';
          ...
          html +='<div class="col-lg-4"></div><div class="col-lg-2"><button type="button" name="edit" id="'+data.care_extra_id[i]+'"  class="btn btn-info edit_data">Edit Record No. '+j+'</button></div></div>';
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title panel panel-info"> <div class="panel-heading" style="padding:7px;">Care related events Edit Form</div></h4>  
