    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu" >
            <ul class="list" >
                ...
                <li class="active open"><a href="dashboard-radiology.php"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
               ...
               <!--  <li><a href="admin-kpi.php"><i class="zmdi zmdi-home"></i><span>K.P.I. - Front Office</span></a></li> -->                                               
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span style="color: #eee; font-size: 13.5px;">Quality Indicators</span> </a>
                    <ul class="ml-menu">
                        ...
                        <li style="background-color: #262626";><a href="#" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Radiology Indicators</a></li>
                        <li><a href="radio_opd_form_r.php" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Radiology Register (OPD)</a></li>
                        <li><a href="radio_ipd_form_r.php" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Radiology Register (IPD)</a></li><br>
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-file-text"></i><span style="color: #eee; font-size: 13.5px;">Audit</span> </a>
                    <ul class="ml-menu">
                        ...
                        <li><a href="radion_saftey_chklst_formNew.php" style="color: #eee; font-size: 13.5px;"> Radiation  Checklist </a></li>
...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Dashboard - Radiology Officer</h2>
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 bg-green hover-zoom-effect">
                    ...
                    <div class="content">
                        <div class="text">Total No. of Test</div>
                        <div class="number"><?php echo number_format($c_count);?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 bg-blush hover-zoom-effect">
                    <div class="icon"> <i class="zmdi zmdi-account col-white"></i> </div>
                    <div class="content">
                        <div class="text">Average (TAT Turn around Time)</div>
                        <div class="number"><?php echo number_format($avgtot / 3600, 2);?>&nbsp;Hrs</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 bg-blue hover-zoom-effect">
                    <div class="icon"> <i class="zmdi zmdi-account col-white"></i> </div>
                    <div class="content">
                        <div class="text">No. Critical Alerts</div>
                        <div class="number"><?php echo number_format($cri_count);?></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="info-box-4 bg-blue-grey hover-zoom-effect">
                    <div class="icon"> <i class="zmdi zmdi-account col-white"></i> </div>
                    <div class="content">
                        <div class="text">Average Critical Alerts Time</div>
                        <div class="number"><?php echo number_format($avgcri / 3600, 2);?>&nbsp;Hrs</div>
                    </div>
                </div>
            </div>
        </div>
          <div class="row clearfix">
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 bg-green hover-zoom-effect">
                    <div class="icon"> <i class="zmdi zmdi-account col-white"></i> </div>
                    <div class="content">
                        <div class="text">% Redos</div>
                        <div class="number"><?php echo number_format($perredo, 2);?>&nbsp;%</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 bg-blush hover-zoom-effect">
                    <div class="icon"> <i class="zmdi zmdi-account col-white"></i> </div>
                    <div class="content">
                        <div class="text">% Reporting of Error</div>
                        <div class="number"><?php echo number_format($pererror, 2);?>&nbsp;%</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="info-box-4 bg-blue hover-zoom-effect">
                    <div class="icon"> <i class="zmdi zmdi-account col-white"></i> </div>
                    <div class="content">
                        <div class="text">% Report Corelating with Clinical Diagnosis</div>
                        <div class="number"><?php echo number_format($perclinical, 2);?>&nbsp;%</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6">
                                ...
                                <form method="post" enctype="multipart/form-data"  id="faq_radio">
                                        ...
                                        <div class="container">
                                             ...
                                             <!--  <button style="background-color: #607D8B;" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">FAQ’S FOR FRONT OFFICE MANUAL</button> -->
                                               ...
                                               <button style="background-color: #607D8B;width: 320px;" type="button" class="btn btn-info btn-lg" class="show_faq_radio" id="show_faq_radio">FAQ’S FOR RADIOLOGY MANUAL</button>
                                              ...
                                              <div class="modal fade" id="myModal8" role="dialog">
                                                ...
                                                <table id="showtab8" cellpadding="0" cellspacing="0" border="1" width="320" style=" text-align: center;border-color: 1px solid gray;">
