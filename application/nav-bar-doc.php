    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu" >
            <ul class="list" >
                ...
                <li class="active open"><a href="Dashboard-doctor.php"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
               ...
               <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span style="color: #eee; font-size: 13.5px; ">Quality Indicators</span> </a>
                ...
                <li style="background-color: #262626";><a href="#" style="color: #eee; font-size: 13.5px; ">Doctor's Related Indicator</a></li>
                        <li><a href="int_asst_form_doc.php" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Initial Assessment Register</a></li>
                        <li><a href="ipd_waittm_form_doc.php" style="color: #eee; font-size: 13.5px; line-height: 2.5;">IPD Discharge Register</a></li>
                        <li><a href="blood_trasfusion_event_doc.php" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Blood Trasfusion Register</a></li><br>
                        ...
                        <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-file-text"></i><span style="color: #eee; font-size: 13.5px;">Quaterly Audit</span> </a>
                            <ul class="ml-menu">
                                <li><a href="https://nabhbuddylive.in/test6Audit/" style="color: #eee; font-size: 13.5px;"></a></li>
                                 ...
                                 <li><a href="death_audit_formNew_doctor.php" style="color: #eee; font-size: 13.5px;">Death Audit</a></li>
                                  <li><a href="clinical_audit_formNew_doctor.php" style="color: #eee; font-size: 13.5px;">Clinical Audit</a></li>
