            ...
            <div class="row">
				...
				<div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="padding:7px;height: 150px;">
                            HR Master Details &nbsp;
                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_hr_mast WHERE year(hr_datej) = '$yr'";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_hr_mast  WHERE hr_emp_type!='' AND year(hr_datej) = '$yr' ";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_hr_mast WHERE hr_emp_type='' AND year(hr_datej) = '$yr'";
					...
					<div class="col-lg-12" style="display: none" id="singimgdiv">
                        ...
                        <div class="col-lg-12">
								...
								<div class="panel panel-default">
									...
									<div class="col-lg-3" style="color:black;">	
										Graphs (Month : <?php echo date('M-Y');?>)
									</div>
								<div class="col-lg-2">
			...
			$.ajax({
				...
				success:function(data)
				{
					...
					$('#sr_no').val(data.sr_no);
                     ...
                     $('#sr').html('<input type="text" name="sr_no" id="sr_no" value="'+data.sr_no+'" class="form-control" readonly />');
					...
					$('#mo6_emp').val(data.mo6_emp);
                     ...
                     if(data.hr_emp_sign==null){
                     	$("#singimgdiv").css("display", "none");
                        	
                     	
                     		console.log('Aditya');
                     }else{

                           $("#singimgdiv").css("display", "block");

                           var htm='<img src="user_upload/hr_images/'+data.hr_emp_sign+'" alt="User Sign Image No Present">';

                           htm +='<input type="hidden" name="oldimg" id="oldimg" value="'+data.hr_emp_sign+'">';
