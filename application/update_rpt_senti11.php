<?php
	...
	{	
		...
		if($_FILES["rpt_rpt1"]["name"] != '' AND $_POST['rpt_doc1'] != '')
		{
			...
			$qry=mysqli_query($connect,"SELECT senti_upld2_doc FROM tbl_senti_upld2 WHERE senti_det_addon_id = '$cid' AND senti_upld2_id = '$vid1'")or die(mysqli_error($connect));
			$rw=mysqli_fetch_array($qry);
			$dname1 = $rw["senti_upld2_doc"];
			unlink( "./upload_senti/".$dname1 );
			$image1 = upload_rpt1();
			$qry2 = "UPDATE tbl_senti_upld2 SET senti_upld2_doc = '$image1' WHERE senti_det_addon_id = '$cid' AND senti_upld2_id = '$vid1'";
