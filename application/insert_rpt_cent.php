		...
		if($_POST['rpt_det1'] != '')
			{
				...
				$qry1 = "SELECT cent_bs_upld_id FROM tbl_cent_bs_upld ORDER BY cent_bs_upld_id DESC";
				$result1 = mysqli_query($connect, $qry1);
				$row1=mysqli_fetch_array($result1);
				$id = $row1['cent_bs_upld_id'];
				$did = $id+1;
				
				$sql1 = "INSERT INTO tbl_cent_bs_upld(cent_bs_upld_id, cent_bs_id, cent_bs_srno, cent_bs_upld_doc_det, cent_bs_upld_doc) 
		...
		if($_POST['rpt_det2'] != '')
			{
				...
				$qry2 = "SELECT cent_bs_upld_id FROM tbl_cent_bs_upld ORDER BY cent_bs_upld_id DESC";
				$result2 = mysqli_query($connect, $qry2);
				$row2=mysqli_fetch_array($result2);
				$id = $row2['cent_bs_upld_id'];
				$did2 = $id+1;
				
				$sql2 = "INSERT INTO tbl_cent_bs_upld(cent_bs_upld_id, cent_bs_id, cent_bs_srno, cent_bs_upld_doc_det, cent_bs_upld_doc) 
		...
		if($_POST['rpt_det3'] != '')
			{
				...
				$sql3 = "INSERT INTO tbl_cent_bs_upld(cent_bs_upld_id, cent_bs_id, cent_bs_srno, cent_bs_upld_doc_det, cent_bs_upld_doc) 
