                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_cath_assoc_uti WHERE year(cath_uti_iuc) = '$yr'";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_cath_assoc_uti WHERE (cath_uti_tcd!='' AND cath_uti_tcd!='0')AND year(cath_uti_iuc) = '$yr'";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_cath_assoc_uti WHERE (cath_uti_tcd='0' OR cath_uti_tcd=' ') AND year(cath_uti_iuc) = '$yr'";
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-2">
									<input type="text" name="todt" id="todt" value="<?php echo $todt;?>" placeholder="To date" class="form-control" />
										...
										<input style="color: #fff;font-weight:bold;" type="submit" name="export" class="btn btn-danger" value="Excel" />
									</div>
								</form>
									<!-- /.panel-heading -->
									<div class="panel-body">
				...
				<div class="form-group">
					<div class="col-lg-12">
						<div class="col-lg-8" style="padding-left:0;">
							...
							<div class="col-lg-4">
								<button style="color: #fff;font-weight:bold;" type="button" name="search" id="search" class="btn btn-info btn-sm" onclick="line_chart()" >SEARCH</button>
							</div>
						</div>
					</div>
				</div>
	...
	$(document).ready(function() {
        ...
        html += '<input type="hidden" value="'+data.tbl_huf_id[i]+'" name="cath_assoc_'+i+'"><br><input type="hidden" value="'+data.cath_assoc_uti_id[i]+'" name="huf_id_'+i+'"><br>';
         html +=' <div class="col-lg-12"><label class="col-lg-4">Whether Sample Positive for CAUTI</label><div class="col-lg-2"><select type="text" name="surg[]" id="surg" class="form-control" value="" disabled ><option value="'+data.nine[i]+'">'+data.nine[i]+'</option></select></div>';
          ...
          html +='<div class="col-lg-4"></div><div class="col-lg-2"><button type="button" name="edit" id="'+data.cath_assoc_uti_id[i]+'"  class="btn btn-info edit_data">Edit Record No. '+j+'</button></div></div>';
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title panel panel-info"> <div class="panel-heading" style="padding:7px;">Cather Associated Unrinary Tract Infection</div></h4>  
