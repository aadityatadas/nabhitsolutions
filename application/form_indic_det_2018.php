...
<div class="container">
        <table class="custom-table">
            <thead>
                <tr>
                    <th rowspan="7">Sr.No.</th>
                    <th>Forms</th>
                    <th ><center>INDICATOR</center></th>
...
<tbody>
	<tr>
		...
		<td valign="top">Hospital Utilization</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Total No. of Inpatient Days</td></tr>
				<tr><td>2. Total No. of Admissions</td></tr>
				<tr><td>3. Total No. of Discharges</td></tr>
				<tr><td>4. Total No. of DAMA</td></tr>
				<tr><td>5. Total No. of Death</td></tr>
				<tr><td>6. Total No. of MLC</td></tr>
				<tr><td>7. Average Length of stay (in Days)</td></tr>
		...
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				...
				<tr>
					...
					?>
					<td id="ajj"><?php echo $dis_count;?></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					...
					?>
					<td id="ajj"><?php echo $dh_count;?></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($loscount,1);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Intial Assessment Time</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>Averarge Intial Assessment Time in Hrs.</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
	...
	<tr>
		...
		<td valign="top">Ventilator Associated Pnemonia Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. VAP Rate</td></tr>
				<tr><td>2. Total Ventilator Days</td></tr>
				<tr><td>3. Positive VAP</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($icount_vent,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $icountv_vent;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $v_count_2;?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Cather Associated Unrinary Tract Infection</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. CAUTI Rate</td></tr>
				<tr><td>2. Total Catheter Days</td></tr>
				<tr><td>3. Positive CAUTI</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($cauti_countcath,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tcdcath3,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $c_cathcount;?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Central Line Associated Blood Stream Infection Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. CLABSI Rate</td></tr>
				<tr><td>2. Total Central Line Days</td></tr>
				<tr><td>3. Positive CLABSI</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($clabsicount,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $tcdclabsi;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $c_countclabsi;?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Surgical Site Infection Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. SSI Rate</td></tr>
				<tr><td>2. Symptoms Of SSI</td></tr>
				<tr><td>3. Positive SSI</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($ssicount,2);?></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					...
					?>
					<td id="ajj"><?php echo $i_ssicount;?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Bed Occupancy Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Total No. of Patient</td></tr>
				<tr><td>2. Total No. of Discharge/Dama/Death</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo $cnt2_bed;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $cnt3_bed;?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">IPD Waiting Time Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>Average IPD Waiting Time</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($totcount_ipd,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">OPD Waiting Time Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Total No. of OPD's</td></tr>
				<tr><td>2. Average OPD Waiting Time in Hrs.</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo $s_count_opd;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($numb3_opd,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Needle Prick Injury Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. No. of Operational Exposure / Needle Prick Injury Incidences</td></tr>
				<tr><td>2. Occupational Exposure Rate / Needle Prick Injury Rate</td></tr>
			</table>
		</td>
		<td colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo $res_needl;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rateneedl2,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Sentinel Event related to surgery and anesthetia</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Total Number of surgeries in the month</td></tr>
				<tr><td>2. Total No of anesthetia given in the month</td></tr>
				<tr><td>3. % of Unplanned return to OT</td></tr>
				<tr><td>4. % of resceduling of surgeries</td></tr>
				<tr><td>5. % of cases where procedure followed to prevent adverse events like (WP/WS/WS)</td></tr>
				<tr><td>6. % of cases where patient given with appropriate prophylactic antibiotics within specified time frame</td></tr>
				<tr><td>7. % of cases where planned surgery changed intraoperatively</td></tr>
				<tr><td>8. Reexploration Rate</td></tr>
				<tr><td>9. % of adverse events related to surgery</td></tr>
				<tr><td>10. Total % of PAC done</td></tr>
				<tr><td>11. % of modification in anesthetia plan</td></tr>
				<tr><td>12. % of unplanned ventilation following anesthetia</td></tr>
				<tr><td>13. % of anesthetia related mortality rate</td></tr>
				<tr><td>14. % of adverse anesthetia related event</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo $rs_surg;?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo $rs_ans;?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($otr1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($otf1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($pnf1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($anti1,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($pl_int1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($rexpl1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($surg_evt1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($pac1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($tp_ans1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($tp_anns1,2);?></center></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><center><?php echo number_format($tp_aans1,2);?></center></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Blood Trasfusion related events</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Average Turn around time for Blood</td></tr>
				<tr><td>2. % of blood transfusion reaction</td></tr>
				<tr><td>3. % of Blood Product Wastage</td></tr>
				<tr><td>4. % of Blood Component Usage</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($min_bld,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($totsbld,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tts,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($ttss,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Care related events</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Thromboplebitis Rate</td></tr>
				<tr><td>2. Hematoma Rate</td></tr>
				<tr><td>3. Bed Score Rate</td></tr>
				<tr><td>4. Patient Fall Rate</td></tr>
				<tr><td>5. Accidental Removal of Drains and Lines Rate</td></tr>
				<tr><td>6. Injury to Patient Rate</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($res_thromb1,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($res_thromb2,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($res_thromb3,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($res_thromb4,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($res_thromb5,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($res_thromb6,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Medical Records Indicator Form</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. % of Missing Records</td></tr>
				<tr><td>2. MRD File In order as per MRD checklist</td></tr>
				<tr><td>3. MRD has Discharge Summary</td></tr>
				<tr><td>4. MRD has codification as per ICD</td></tr>
				<tr><td>5. MRD has incomplete or Improper Consent</td></tr>
				<tr><td>6. Medication orders are properly written</td></tr>
				<tr><td>7. Handover Sheet of Doctors are properly filled</td></tr>
				<tr><td>8. Handover Sheet of Nurses are properly filled</td></tr>
				<tr><td>9. The Plan of care is documented with desired outcome and countersigned by clinicians</td></tr>
				<tr><td>10. MRD includes screening for nutritional needs (Nutritional Assessment)</td></tr>
				<tr><td>11. MRD Includes Nursing care plan is documented with outcome at the time of admission</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls_medi,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls2_medi2,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls3_medi3,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls4_medi4,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls5_medi5,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls6_medi6,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls6_medi7,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls6_medi8,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls6_medi9,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls6_media,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($rexpls6_medib,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">HR Indicator</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Employee Absentism Rate</td></tr>
				<tr><td>2. Employee Satisfaction Rate</td></tr>
				<tr><td>3. Employee Griviences rate</td></tr>
				<tr><td>4. Needle Prick Injury Rate</td></tr>
				<tr><td>5. Occupational Exposure rate</td></tr>
				<tr><td>6. % of complete HR files</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tabs1_hr,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tabs2_hr,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tabs3_hr,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tabs4_hr,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tabs5_hr,2);?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tabs6_hr,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">Equipment Indicator</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Equipement Breakdown Time</td></tr>
				<tr><td>2. No. of Equipement under Warranty</td></tr>
				<tr><td>3. No. of Equipement under AMC</td></tr>
				<tr><td>4. % of AMC</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($mineqp,2);?></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($tt5eqp,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">IPD FEEDBACK FORM</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Total No. of IPD Patient</td></tr>
				<tr><td>2. Total No. of Patient Who Has Given Feedback</td></tr>
				<tr><td>3. IPD Satisfaction Index</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo $res4_ipdf;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $res2_ipdf;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($resulipdf,2);?></td>
					<?php
						}
					?>
				</tr>
	...
	<tr>
		...
		<td valign="top">OPD FEEDBACK FORM</td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr><td>1. Total No. of OPD Patient</td></tr>
				<tr><td>2. Total No. of Patient Who Has Given Feedback</td></tr>
				<tr><td>3. OPD Satisfaction Index</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr>
					...
					?>
					<td id="ajj"><?php echo $res4_opdf;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo $res2_opdf;?></td>
					<?php
						}
					?>
				</tr>
				<tr>
					...
					?>
					<td id="ajj"><?php echo number_format($resulopdf,2);?></td>
					<?php
						}
					?>
				</tr>
