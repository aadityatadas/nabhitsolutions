...
<li>
                        ...
                        <li>
                          ...
                          <li style="border-bottom: 0px; ">
                            <a href="#" style="color:#999; "><i class="fa fa-home fa-fw"></i><b> HR Related Indicators</b></a>
                        </li>
                         <li style="border-bottom: 0px; "> 
                            <a href="hr_mast1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> HR Master</a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="hr_indicator1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> HR Indicator</a>
                        </li>
                         <!--<li>
