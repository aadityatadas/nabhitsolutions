<?php
	...
	{	
		...
		{
			$qry=mysqli_query($connect,"SELECT eqp_dtins_img FROM tbl_eqp_mast WHERE eqpid = '$cid'")or die(mysqli_error($connect));
			...
			$qry2 = "UPDATE tbl_eqp_mast SET eqp_dtins_img = '$imagetw' WHERE eqpid = '$cid'";
