...
<?php  
    $sqld = "SELECT tbl_menus.name,tbl_menus.url FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.category_name='dashboard'";  
    ...
    <?php if (mysqli_num_rows($resultd) > 0) { 
            ...
            <li class="active open"><a href="<?=$rowd['url']?>"><i class="zmdi zmdi-home"></i><span><?=$rowd['name']?></span></a></li>
...
<?php  
    $sql1 = "SELECT tbl_menus.name,tbl_menus.url,tbl_menus.class_name,tbl_menus.style FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.parent_id=21";  
...
$result1 = mysqli_query($connect, $sql1);
    ...
    <?php if (mysqli_num_rows($result1) > 0) { 
            ...
            <li style="<?=$row1['style']?>";><a href="<?=$row1['url']?>" style="color: #eee; font-size: 13.5px;"><?=$row1['name']?></a></li>
...
<?php 
        ...
        $ret=mysqli_query($connect,"SELECT tbl_menus.* FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.id=64")or die(mysqli_error($connect));
        ...
        { ?>
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span style="color: #eee; font-size: 13.5px;">Audit</span> </a>
                    <?php  
    $sqldQ = "SELECT tbl_menus.id,tbl_menus.name,tbl_menus.url,tbl_menus.style,tbl_menus.is_parent FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.parent_id='".$rs['id']."'";  

    $resultdQ = mysqli_query($connect, $sqldQ);

    ?>

    <?php if (mysqli_num_rows($resultdQ) > 0) {  ?>
            <ul class="ml-menu">
         <?php   while($rowdQ = mysqli_fetch_assoc($resultdQ)) {
            ?>


                        
            <li ><a href="<?=$rowdQ['url']?>" class="menu-toggle" style="<?=$rowdQ['style']?>"><i class="zmdi zmdi-file-text"></i><span style="color: #eee; font-size: 13.5px;"><?=$rowdQ['name']?></span> </a>

            <?php if($rowdQ['is_parent']==1){ ?>
                <ul class="ml-menu">

        <?php 
          $sqlE11 = "SELECT tbl_menus.id,tbl_menus.name,tbl_menus.url,tbl_menus.class_name,tbl_menus.style,tbl_menus.is_parent FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.parent_id=".$rowdQ['id'];   

          $resultE11 = mysqli_query($connect, $sqlE11);

        ?>

         
            
             <?php if (mysqli_num_rows($resultE11) > 0) { 
           
                    while($rowE11 = mysqli_fetch_assoc($resultE11)) {

            ?>

           <?php if($rowE11['is_parent']==1){?>
                
               

                <li><a href="<?=$rowE11['url']?>" class="menu-toggle"><i class="zmdi zmdi-account-add"></i><span style="color: #eee; font-size: 13.5px;"><?=$rowE11['name']?></span> </a>


        <ul class="ml-menu">

        <?php 
          $sqlE12 = "SELECT tbl_menus.name,tbl_menus.url FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.parent_id=".$rowE11['id'];   

          $resultE12 = mysqli_query($connect, $sqlE12);

        ?>

         
            
             <?php if (mysqli_num_rows($resultE12) > 0) {  

              
           
                    while($rowE12 = mysqli_fetch_assoc($resultE12)) {

            ?>

            <li><a href="<?=$rowE12['url']?>" style="color: #eee; font-size: 13.5px;"><i class="fa fa-minus"></i>  <?=$rowE12['name']?></a></li>
        ...
        <?php } 
            ...
            <?php } else { ?>
                ...
                <li><a href="<?=$rowE11['url']?>" style="color: #eee; font-size: 13.5px;"><?=$rowE11['name']?> </a></li>
    ...
    <?php  
    $sqlE = "SELECT tbl_menus.id,tbl_menus.name,tbl_menus.url,tbl_menus.class_name,tbl_menus.is_parent FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.category_name='extra'";  
        ...
        ?>
         ...
         <?php if (mysqli_num_rows($resultE) > 0) { 
            ...
            ?>
             ...
             <li><a href="<?=$rowE['url']?>" class="menu-toggle"><i class="<?=$rowE['class_name']?>"></i><span style="color: #eee; font-size: 13.5px;"><?=$rowE['name']?></span> </a>
            <?php if($rowE['is_parent']==1){ ?>
                <ul class="ml-menu">

        <?php 
          $sqlE1 = "SELECT tbl_menus.name,tbl_menus.url,tbl_menus.class_name FROM tbl_menus
        INNER JOIN tbl_menus_types ON tbl_menus.id=tbl_menus_types.menu_id
        WHERE tbl_menus_types.user_type_id=".$_SESSION['type_id']." AND tbl_menus.parent_id=".$rowE['id'];   

          $resultE1 = mysqli_query($connect, $sqlE1);

        ?>

         
            
             <?php if (mysqli_num_rows($resultE1) > 0) { 
           
                    while($rowE1 = mysqli_fetch_assoc($resultE1)) {

            ?>

            <?php if($rowE1['class_name']=='url'){ ?>



                    <li><a href="<?=$rowE1['url']?><?=$_SESSION['email']?>/<?=$_SESSION['password']?>/<?=$_SESSION['department']?>" style="color: #eee; font-size: 13.5px;"><?=$rowE1['name']?> </a></li>
                        
                  <?php }else{ ?>        
                     <li><a href="<?=$rowE1['url']?>" style="color: #eee; font-size: 13.5px;"><?=$rowE1['name']?> </a></li>
