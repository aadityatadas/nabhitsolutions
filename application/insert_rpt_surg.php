		...
		if($_FILES["rpt_rpt1"]["name"] != '')
			{
				...
				$qry1 = "SELECT surg_upld_id FROM tbl_surg_upld ORDER BY surg_upld_id DESC";
				$result1 = mysqli_query($connect, $qry1);
				$row1=mysqli_fetch_array($result1);
				$id = $row1['surg_upld_id'];
				$did = $id+1;
				
				$sql1 = "INSERT INTO tbl_surg_upld(surg_upld_id, surg_id, surg_srno, surg_upld_doc_det, surg_upld_doc) 
		...
		if($_FILES["rpt_rpt2"]["name"] != '')
			{
				...
				$qry2 = "SELECT surg_upld_id FROM tbl_surg_upld ORDER BY surg_upld_id DESC";
				$result2 = mysqli_query($connect, $qry2);
				$row2=mysqli_fetch_array($result2);
				$id = $row2['surg_upld_id'];
				$did2 = $id+1;
				
				$sql2 = "INSERT INTO tbl_surg_upld(surg_upld_id, surg_id, surg_srno, surg_upld_doc_det, surg_upld_doc) 
		...
		if($_FILES["rpt_rpt3"]["name"] != '')
			{
				...
				$sql3 = "INSERT INTO tbl_surg_upld(surg_upld_id, surg_id, surg_srno, surg_upld_doc_det, surg_upld_doc) 
