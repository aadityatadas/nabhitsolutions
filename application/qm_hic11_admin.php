<?php
	...
	$qry = "SELECT DISTINCT month_id FROM tbl_audit_hh11";
        ...
        <div id="page-wrapper">
                    ...
                    <div class="panel panel-primary">
		                    	 ...
		                    	 <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$tot= "SELECT COUNT(*) as total FROM tbl_audit_hh11 WHERE year(created) = '$yr'";
														...
														$qrycomp = "SELECT COUNT(*) as comp FROM tbl_audit_hh11 WHERE sign!='' AND year(created) = '$yr' ";
																$rescomp = mysqli_query($connect, $qrycomp);
																$rowcomp=mysqli_fetch_assoc($rescomp);
																// echo $rowcomp['comp'];
																											

														$qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_audit_hh11 WHERE sign='' AND year(created) = '$yr' ";
						...
						<div class="box" id="bx1">
							<div id="adm">
								...
								<div class="col-lg-12">
									<label class="col-md-12" style="color: #333; background-color: #9ac6eb!important; border-color: #9ac6eb!important; text-align: center; padding:10px;"> Care of Invasive device : Central line / dialysis catheter / Peripheral line / PAP line/ Arterial line </label>
									<div class="col-lg-12">
										<table class="table table-bordered">
													<thead>
														<tr>
															<th>sr.no</th>
															<th width="30%"><strong>Care of Central Venous Catheter
															<th>Yes</th>
															<th>No</th>
															<th>NA</th>
															<th>Comment</th>
			...
			<textarea name="arrVal[<?= $n ?>][2]" rows="2" id="cmt<?= $n ?>" cols="40"></textarea></td>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-9">
												<input type="text" autocomplete="off" name="sign" id="sign" 
												 ...
												 <input type="hidden" name="tbl" value="tbl_audit_hh11">
											</div>
                        ...
                        <div class="col-lg-12" style="text-align:center">
								<form method="post" action="audit_hh/hic11Pdf.php"  target="print_popup"  onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
									<div class="panel-heading">
										...
										<input type="hidden" name="tblname" value="tbl_audit_hh11">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p style="text-align: center;"><b><font color="#000000">Care of Invasive device : Central line / dialysis catheter / Peripheral line / PAP line/ Arterial line</font></b></p>
 ...
 <script>
    	...
    	$(document).on('click', '#myModel', function(){
          ...
          //alert(uid);
            ...
            $.ajax({
                method:"POST",
				url: "audit_hh/hic11Excel.php",
				data:{user_id:uid,tbl:'tbl_audit_hh11',ptbl:'ptbl'},
                cache: false,
	...
	$(document).ready(function() {
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				...
				method:"POST",
				data:{user_id:user_id,tbl:'tbl_audit_hh11'},
				dataType:"json",
				success:function(data)
				{
					$('#bx1').show('fast');
