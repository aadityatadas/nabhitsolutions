...
foreach($result as $row)
{
	$sub_array = array();
	$centid = $row["needp_id"];
	$sub_array[] = '<a style="cursor:pointer;" title="Click here to edit" id="'.$row["needp_id"].'" class="update" ><i style="color:darkblue;" class="fa fa-edit fa-fw"></i></a>&nbsp;&nbsp;<a style="cursor:pointer;" title="Click here to delete" id="'.$row["needp_id"].'" class="delete" ><i style="color:red;" class="fa fa-trash-o fa-fw"></i></a>';
