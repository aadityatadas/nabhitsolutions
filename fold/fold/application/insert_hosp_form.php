...
if(isset($_POST["operation"]))
{
	...
	if($_POST["operation"] == "Edit")
	{
		...
		$statement = $connection->prepare(
			"UPDATE tbl_huf 
			SET huf_pname = :p_name, huf_uhid = :uhid_no, huf_ipd = :ipd_no, huf_dadm = '$d1', huf_tadm = :t_adm, huf_ddd = :ddd, huf_dddd = '$d2', huf_tddd = :tddd, huf_mlc = :mlc, huf_surg = :surg, huf_lens = '$days', huf_my = '$d_my', huf_recd = '$ses'  
			WHERE huf_id = :sr_no
			"
		);
		$result = $statement->execute(
