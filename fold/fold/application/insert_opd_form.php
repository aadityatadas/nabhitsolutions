...
if(isset($_POST["operation"]))
{
	...
	$chkk1 = mysqli_real_escape_string($connect, $_POST["chkk1"]);
	$chkk2 = mysqli_real_escape_string($connect, $_POST["chkk2"]);
	$chkk3 = mysqli_real_escape_string($connect, $_POST["chkk3"]);
	...
	if($_POST["operation"] == "Edit")
	{
		...
		opd_date='$d_t',opd_name='$name',opd_age='$age',opd_sex='$sex',opd_email='$email',opd_addr='$addr',opd_trdr='$tdr',opd_hrd1='$chkk1',opd_hrd2='$chkk2',opd_hrd3='$chkk3',
		...
		opd_chk19='$chk19', opd_chk20='$chk20', opd_chk21='$chk21', opd_chk22='$chk22', opd_chk23='$chk23', opd_chk24='$chk24', opd_fac='$rfd', opd_sug='$aos', opd_user='$ses'
		";
