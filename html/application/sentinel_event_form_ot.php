...
<script>	
	...
	$(document).ready(function() {
		...
		$(document).on('click', '.update', function(){
          ...
          html +='<div class="col-lg-4"></div><div class="col-lg-2"><button type="button" name="edit" id="'+data.twentytwo[i]+'"  class="btn btn-primary edit_data">Edit Record No. '+j+'</button></div></div>';
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title panel panel-primary"> <div class="panel-heading" style="padding:7px;">Sentinel Event related to surgery and anesthetia  </div></h4>  
