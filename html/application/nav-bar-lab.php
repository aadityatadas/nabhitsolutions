     ...
     <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color: #337ab7;">
        ...
        onMouseOut="this.style.color='white'";>
            ...
            <li style="border-bottom: 0px; ">
              ...
              <li style="border-bottom: 0px; ">
                <a href="dashboard-laboratory.php" style="color:#999; "><i class="fa fa-home fa-fw"></i><b> Laboratory </b> </a>
              </li>
             ...
             <li style="border-bottom: 0px; ">
              <a href="lab_opd_form1.php"  style="color:#999;"><i class="glyphicon glyphicon-record"></i> Laboratory Indicator</a>
             </li>
             ...
             <li style="border-bottom: 0px; ">
               <a href="lab_ipd_form1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Laboratory Indicator</a>
             </li>
