<?php
	...
	{	
		...
		{
			$qry=mysqli_query($connect,"SELECT eqp_idno_img FROM tbl_eqp_mast_bio WHERE eqpid = '$cid'")or die(mysqli_error($connect));
			...
			$qry2 = "UPDATE tbl_eqp_mast_bio SET eqp_idno_img = '$imageon' WHERE eqpid = '$cid'";
