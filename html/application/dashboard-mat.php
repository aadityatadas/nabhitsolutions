	...
	<div id="wrapper">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo number_format($ssicount, 2);?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $numb3;?><small style="color: white";>&nbsp;Hrs.</small></h3>

              <p>Averarge Intial Assessment Time</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo number_format($totcount,2);?> <small style="color: white";> Hrs. </small></h3> 

              <p>Averarge IPD waiting Time</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo ($no_of_emer);?></h3>

              <p>Total No. Emergency</p>
            </div>
            <div class="icon">
                <i class="ion ion-person-add"></i>
            </div>
