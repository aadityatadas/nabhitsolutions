          ...
          <span style="font-size: 15px; color: white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NABH For Hospitals And Healthcare Providers.
            ...
            <div class="navbar-default sidebar" role="navigation" style="border-color:#333; font-size: 13px; color: #e6eeff; font-weight: 100; font-family:sans-serif; line-height: 2.428571;" onMouseOver="this.style.color='black'"
             ...
             <li style="border-bottom: 0px;"  class="w3-bar">
              <a href="dashboard-otnur.php" style="color:#e6eeff; border:5px; background-color: #ffffff00;"><i class="fa fa-dashboard"></i>&nbsp;  Dashboard</a>
            </li>   
...
<!-- 
              ...
              <li style="border-bottom: 0px; ">
               <a href="#" style="color: #e6eeff; background-color:   #261a0d;"><i class="fa fa-home fa-fw"></i>  OT  Indicators</a>
             </li>
                        

             <li style="border-bottom: 0px; ">
              <a href="sentinel_event_form_ot.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> OT Register<br>&nbsp;&nbsp;&nbsp;&nbsp; (Sentinel Event - Surgical <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and Anesthetia Events)</a>
             </li>
