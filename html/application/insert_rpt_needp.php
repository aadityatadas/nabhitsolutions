		...
		if($_POST['rpt_det1'] != '')
			{
				...
				$qry1 = "SELECT needp_upld_id FROM tbl_need_upld ORDER BY needp_upld_id DESC";
				$result1 = mysqli_query($connect, $qry1);
				$row1=mysqli_fetch_array($result1);
				$id = $row1['needp_upld_id'];
				$did = $id+1;
				
				$sql1 = "INSERT INTO tbl_need_upld(needp_upld_id,needp_id,needp_srno,needp_upld_doc_det,needp_upld_doc) 
		...
		if($_POST['rpt_det2'] != '')
			{
				...
				$qry2 = "SELECT needp_upld_id FROM tbl_need_upld ORDER BY needp_upld_id DESC";
				$result2 = mysqli_query($connect, $qry2);
				$row2=mysqli_fetch_array($result2);
				$id = $row2['needp_upld_id'];
				$did2 = $id+1;
				
				$sql2 = "INSERT INTO tbl_need_upld(needp_upld_id,needp_id,needp_srno,needp_upld_doc_det,needp_upld_doc) 
		...
		if($_POST['rpt_det3'] != '')
			{
				...
				$sql3 = "INSERT INTO tbl_need_upld(needp_upld_id,needp_id,needp_srno,needp_upld_doc_det,needp_upld_doc) 
