...
<script type="text/javascript">
	...
	function ()
	{
	$('#hosp').load('biomedicaleqip_sfty_chklist/biomedicaleqip_sfty_chklst_count.php').fadeIn("slow");
							...
							<div class="col-lg-12">
								<label class="col-md-12" style="color: #333; background-color: #9ac6eb!important; border-color: #9ac6eb!important; text-align: center; padding:10px;">  <?=$rowHead[0];?></label>
									...
									<div class="col-lg-2" ><?=$rowHead[0];?></div>
											<div class="col-lg-4">
												<select type="text" 
												name="list_upted_tag_yn" 
												id="list_upted_tag_yn" 
												onChange="LoadData();" 
												class="form-control" />
											...
											<div class="col-lg-4">
												<select type="text" 
												name="list_upted_tag_loc" 
												id="list_upted_tag_loc" onChange="LoadData();" 
												class="form-control" />
                              ...
                              <?php endforeach;  ?> 
                               <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="list_upted_tag_rmrk" 
												id="list_upted_tag_rmrk" 
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="critical_bio_equmnt_yn" 
												id="critical_bio_equmnt_yn" onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="critical_bio_equmnt_loc" 
												id="critical_bio_equmnt_loc" onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
								<?php   foreach($checklist_locations as $loc): ?>
                                ...
                                <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="critical_bio_equmnt_rmrk" 
												id="critical_bio_equmnt_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="prvintv_maintce_reports_yn" 
												id="prvintv_maintce_reports_yn" 
											...
											<div class="col-lg-4">
												<select type="text" 
												name="prvintv_maintce_reports_loc" 
												id="prvintv_maintce_reports_loc" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
							<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?> 
                               <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="prvintv_maintce_reports_rmrk" 
												id="prvintv_maintce_reports_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="calibratn_reports_yn" 
												id="calibratn_reports_yn" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="calibratn_reports_loc" 
												id="calibratn_reports_loc" 
												onChange="LoadData();" 
												class="form-control" />
                              ...
                              <?php endforeach;  ?>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="calibratn_reports_rmrk" 
												id="calibratn_reports_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="breakdown_equpment_yn" 
												id="breakdown_equpment_yn" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="breakdown_equpment_loc" 
												id="breakdown_equpment_loc" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
								<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="breakdown_equpment_rmrk" 
												id="breakdown_equpment_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="dos_dont_precution_yn" 
												id="dos_dont_precution_yn" onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="dos_dont_precution_loc" 
												id="dos_dont_precution_loc" onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
							<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="dos_dont_precution_rmrk" 
												id="dos_dont_precution_rmrk" class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="emrgncy_alarm_loc" 
												id="emrgncy_alarm_loc" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
								<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="emrgncy_alarm_rmrk" 
												id="emrgncy_alarm_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="intrnl_extrnl_repots_yn" 
												id="intrnl_extrnl_repots_yn" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="intrnl_extrnl_repots_loc" 
												id="intrnl_extrnl_repots_loc" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
							<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="intrnl_extrnl_repots_rmrk" 
												id="intrnl_extrnl_repots_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="all_wires_use_loc" 
												id="all_wires_use_loc" onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
							<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="all_wires_use_rmrk" 
												id="all_wires_use_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="qualified_biomedcl_checks_yn" 
												id="qualified_biomedcl_checks_yn" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="qualified_biomedcl_checks_loc" 
												id="qualified_biomedcl_checks_loc" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
								<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="qualified_biomedcl_checks_rmrk" 
												id="qualified_biomedcl_checks_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
