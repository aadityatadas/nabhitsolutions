...
<body>
    ...
    <div id="wrapper">
		...
		<div class="col-lg-12">
											<label class="col-lg-4">Date & Time of Intubation/Ventilation on</label>
											<div class="col-lg-2">
												<input type="text" autocomplete="off" name="newData[0]['t_adm']" id="t_admAdi0" placeholder="yyyy-mm-dd" class="form-control dateDisplay" />
											</div>
											<div class="col-lg-2">
												<input type="time" name="newData[0]['t_adm1']" id="adi" placeholder="hh:mm" 
												class="form-control" />
											</div>
										</div>
	<div class="col-lg-12">
											<label class="col-lg-4">Date & Time of Intubation/Ventilation on</label>
											<div class="col-lg-2">
												<input type="text" autocomplete="off" name="newData[1]['t_adm']" id="t_admAdi1" placeholder="yyyy-mm-dd" class="form-control dateDisplay" />
											</div>
											<div class="col-lg-2">
												<input type="time" name="newData[1]['t_adm1']" id="adi" placeholder="hh:mm" 
												class="form-control" />
											</div>
										</div>
	 
<div class="col-lg-12">
<div id="carton_request">
...
<script>	
	$(document).ready(function() {
		...
		$(document).on('click', '.update', function(){
          ...
          var html = '<div class="col-lg-12"><label class="col-lg-4">Date & Time of Intubation/Ventilation on</label><div class="col-lg-2"><input type="text" autocomplete="off" name="newData[2]["t_adm"]" id="t_admAdi2" placeholder="yyyy-mm-dd" class="form-control dateDisplay" /></div><div class="col-lg-2"><input type="time" name="newData[2]["t_adm1"]" id="adi" placeholder="hh:mm" class="form-control" /></div></div>';
          $('#carton_request').append(html);
            for(var i=0;i<3;i++){
            	    jQ_append(i, '2019-02-20');
            }
					//$('input[name=newData[0]["t_adm"]]').val("1111-11-11")
					$('#ddd').val(data.ddd);
					$('#ddd1').val(data.ddd1);
					$('#dddd').val(data.dddd);
