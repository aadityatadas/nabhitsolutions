...
foreach($result as $row)
{
	...
	if($row1["opd_charges"]){
			$sub_array[] = '<a style="cursor:pointer;" title="Click here to edit" id="'.$row["opdwttm_id"].'" class="update" ><i style="color:darkblue;" class="fa fa-edit fa-fw"></i></a>&nbsp;&nbsp;<a style="cursor:pointer;" title="Click here to delete" id="'.$row["opdwttm_id"].'" class="delete" ><i style="color:red;" class="fa fa-trash-o fa-fw"></i></a>&nbsp;&nbsp;<a style="cursor:pointer;" title="Click here to print receipt" href="receipts/opd_receipt_print.php?opdwttm_id='.md5($row["opdwttm_id"]).'" target="_blank" class="print_btn" ><i style="color:green;" class="fa fa-print fa-fw"></i></a>';

	} else {
		$sub_array[] = '<a style="cursor:pointer;" title="Click here to edit" id="'.$row["opdwttm_id"].'" class="update" ><i style="color:darkblue;" class="fa fa-edit fa-fw"></i></a>&nbsp;&nbsp;<a style="cursor:pointer;" title="Click here to delete" id="'.$row["opdwttm_id"].'" class="delete" ><i style="color:red;" class="fa fa-trash-o fa-fw"></i></a>';
