...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
          ...
          <span style="font-size: 15px; color: white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NABH For Hospitals And Healthcare Providers.
            ...
            <div class="navbar-default sidebar" role="navigation" style="border-color:#333; font-size: 13px; color: #e6eeff; font-weight: 100; font-family:sans-serif; line-height: 2.428571;" onMouseOver="this.style.color='black'"
             ...
             <li style="border-bottom: 0px;"  class="w3-bar">
              <a href="dashboard-engin.php" style="color:#e6eeff; border:5px; background-color: #ffffff00;"><i class="fa fa-dashboard"></i>&nbsp;  Dashboard</a>
            </li>   
 ...
 -->
             ...
             <li style="border-bottom: 0px; ">
               <a href="equip_mast_bio_engg.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Bio Equipment Master</b> </a>
             </li>

              <li style="border-bottom: 0px; ">
               <a href="equip_indicator_form_bio_engg.php"  style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Bio Maintenance Register</b> </a>
             </li>
            ...
            <li style="border-bottom: 0px; ">
               <a href="equip_mast_engg.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> General Equipment Master</b> </a>
             </li>

              <li style="border-bottom: 0px; ">
               <a href="equip_indicator_form_engg.php"  style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> General Maintenance <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Register</b> </a>
             </li>
 

<!-- 
            <li style="border-bottom: 0px; ">
              <a href="#" style="color: #e6eeff; background-color:   #261a0d;" ><i class="fa fa-home fa-fw"></i>  Equipement  Related &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Indicators</a>
            </li>
             ...
             <li style="border-bottom: 0px; ">
               <a href="equip_mast_engg.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Equipement Master</b> </a>
             </li> -->
            ...
            <!--   
             <li style="border-bottom: 0px; ">
               <a href="equip_indicator_form_engg.php"  style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Equipement Indicator</b> </a>
             </li>
 -->
             <!-- <li style="border-bottom: 0px; ">
               <a href="" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Laboratory Indicator</a>
 ...
 --><!-- 
  ...
  -->
           ...
           <!--  <li style="border-bottom: 0px; ">
            ...
            <!-- <li style="border-bottom: 0px; ">
              <a href="#" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Control Charts </a>
            </li> -->
