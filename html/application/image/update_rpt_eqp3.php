<?php
	...
	{	
		...
		{
			$qry=mysqli_query($connect,"SELECT amcs_img FROM tbl_eqp_mast WHERE eqpid = '$cid'")or die(mysqli_error($connect));
			...
			$qry2 = "UPDATE tbl_eqp_mast SET amcs_img = '$imageth' WHERE eqpid = '$cid'";
