            ...
            <div class="navbar-default sidebar" role="navigation" style="border-color:#333; margin-top: 50px;">
                ...
                <div class="sidebar-nav navbar-collapse" style="background-color:#222d32;">
                    <ul class="nav" id="side-menu" >
                       ...
                       <!-- <li>
						...
						<li>
                            ...
                            <a href="dashboard-mrdoffice.php" style="color:#999; "><i class="fa fa-home fa-fw"></i> MRD Officer </a>
                        </li>
                        ...
                        <li style="border-bottom: 0px; ">
                            <a href="medi_records_indicator1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Medical Records Indicator</a>
                        </li>
                          <!--<li>
					...
					<li>
						...
						<li style="border-bottom: 0px; ">
                            <a href="form_indicator1.php"style="color:#999; "><i class="glyphicon glyphicon-record"></i> Form Indicators</a>
                        </li>

                        
                        
						<li style="border-bottom: 0px; ">
                            <a href="chart_det1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Control Charts </a>
                        </li>
