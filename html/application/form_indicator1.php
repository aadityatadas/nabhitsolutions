    ...
    <div id="wrapper">
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-12">
					<a href="http://localhost/criticare/hms/test6/application/dashboard-mrdoffice.php"><button type="button" class="btn btn-default pull-left"><< Back To Dashboard</button></a>
				</div>
                <div class="col-lg-12">
					<br />
				</div>
