...
<body>
	<?php include"nav-bar-laboratory.php";?>
	<div class="preload">
...
html +='<div class="col-lg-12"><label class="col-lg-4">Name of LAB Personnel</label><div class="col-lg-7"><input type="text" autocomplete="off" name="Remarksold[]" id="Remarksold'+i+'" placeholder="name of LAB Personnel" class="form-control" value="'+data.Remarks_old[i]+'" readonly /></div></div>';
          ...
          html +='<div class="col-lg-4"></div><div class="col-lg-2"><button type="button" name="edit" id="'+data.lab_ipd_extra_id[i]+'"  class="btn btn-primary edit_data">Edit Record No. '+j+'</button></div></div>';
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title panel panel-primary"> <div class="panel-heading" style="padding:7px;">Laboratory Indicator Form Edit Form</div></h4>  
