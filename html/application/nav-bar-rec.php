           ...
           <!--  <script src="../vendor/date_time.js"></script>
            <div class="navbar-default sidebar" role="navigation" style="border-color:#333; font-size: 13px; color: #e6eeff; font-weight: 100; font-family:sans-serif; line-height: 2.428571;" onMouseOver="this.style.color='black'"
             ...
             <li style="border-bottom: 0px;"  class="w3-bar">
              <a href="dashboard-reception.php" style="color:#e6eeff; border:5px; background-color: #ffffff00;"><i class="fa fa-dashboard"></i>&nbsp;   Dashboard</a>
            </li>   

            <li style="border-bottom: 0px; ">
              <a href="#" style="color: #e6eeff; background-color:   #261a0d;" ><i class="fa fa-home fa-fw" ></i>  Front Office/Reception </a>
            </li> 

            <li style="border-bottom: 0px;" class="w3-bar">
              <a href="hosp_util_form_rec.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw" ></i> IPD Register</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="opd_waittm_form_det_rec.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i>  OPD Register </a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="bed_occup_form_rec.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Bed Occupancy Report</a>
           </li>

            <li style="border-bottom: 0px; ">
              <a href="opd_feedback_form_rec.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> OPD Feedback Form</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="ipd_feedback_form_rec.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> IPD Feedback Form</a>
            </li> -->
            ...
            <li style="border-bottom: 0px; ">
              <a href="#" style="color: #e6eeff; background-color: #272525; "><i class=" fa fa-home fa-fw"></i> Doctor's Related Indicator</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="int_asst_form.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i>  Initial Assessment Time</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="ipd_waittm_form.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> IPD Discharge Time</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="blood_trasfusion_event.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Blood Trasfusion Events</a>
            </li>
 ...
 -->
  ...
  -->
           ...
           <!--  <li style="border-bottom: 0px; ">
            ...
            <!-- <li style="border-bottom: 0px; ">
              <a href="chart_det.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Control Charts </a>
            </li> -->
...
<link rel="stylesheet" href="../css/style.css">
 ...
 <nav class="navbar navbar-default navbar-top" role="navigation" style="margin-bottom: 0; background-color: #337ab7;">
...
<div class="nav-side-menu" style="margin-top: -20px; position: absolute;">
    <div class="brand" style="font-size: 16px;">RECEPTION</div>
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                <li>
                  <a href="dashboard-reception.php">
                  <i class="fa fa-dashboard fa-lg"></i> K.P.I. - Front Office
                  </a>
                </li>

                <li  data-toggle="collapse" data-target="#products" class="collapsed active">
                  <a href="#"><i class="glyphicon glyphicon-list"></i> Quality Indicators <span class="arrow"></span></a>
                </li>
                <ul class="sub-menu collapse" id="products">
                    <li class="active"><a href="#">RECEPTION</a></li>
                    <li><a href="hosp_util_form_rec.php">IPD Register</a></li>
                    <li><a href="opd_waittm_form_det_rec.php">OPD Register</a></li>
                    <li><a href="bed_occup_form_rec.php">Bed Occupancy Report</a></li>
                    <li><a href="opd_feedback_form_rec.php">OPD Feedback Form</a></li>
                    <li><a href="ipd_feedback_form_rec.php">IPD Feedback Form</a></li>
                ...
                <li data-toggle="collapse" data-target="#service" class="collapsed">
                  <a href="#"><i class="glyphicon glyphicon-dashboard"></i> Audit <span class="arrow"></span></a>
                </li>  
                <ul class="sub-menu collapse" id="service">
                  <li><a href="dashboard1-audit.php">Daily Checklist</a></li>
                  <li><a href="#">Monthly Audit</a></li>
                  <li><a href="#">NABH Status Scoreboard</a></li>
                </ul>


                <li data-toggle="collapse" data-target="#new" class="collapsed">
                  <a href="#"><i class="glyphicon glyphicon-dashboard"></i> Training <span class="arrow"></span></a>
                </li>
                <ul class="sub-menu collapse" id="new">
                 ...
                 <li>
                  <a href="#">
                  <i class="glyphicon glyphicon-dashboard"></i> Backup Database
                  </a>
                  </li>
