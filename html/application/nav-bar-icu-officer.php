...
<!-- 
 ...
 -->
             <!--  <li style="border-bottom: 0px; ">
              ...
              <li style="border-bottom: 0px; ">
                <a href="icu_register_ipd_form_ICU.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> ICU Register</a>
              </li>
