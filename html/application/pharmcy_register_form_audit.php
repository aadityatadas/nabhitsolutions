				...
				<div class="col-lg-12">
                    <div class="panel panel-primary">
						...
						<div class="col-lg-12">
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Total No. of Item Purchases</label>
											<div class="col-lg-7">
												<input type="text" name="item_no" id="item_no" class="form-control" placeholder="Total No. of Item Purchases" required />
											</div>
										</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<input type="text" name="quantity" id="quantity" class="form-control" placeholder="Total No. of Sold Items" />
											</div>
										</div>
                        ...
                        <div class="box" id="bx2">
							<div class="panel-body">
							 ...
							 <form method="post" action="../excel/PHR/export.php" class="panel-heading">
