...
function cal_data($tablename , $hufdt , $connect){
	...
	//$i_count = $res["std"];
	$qry3 = mysqli_query($connect,"SELECT * FROM $tablename WHERE (sample_rec_date  = '$hufdt') AND redos = 'Yes'")or die(mysqli_error($connect));
	...
	$qry4 = mysqli_query($connect,"SELECT * FROM $tablename WHERE (sample_rec_date  = '$hufdt') AND resp_err = 'Yes'")or die(mysqli_error($connect));
	$error = mysqli_num_rows($qry4);
	

	$qry5 = mysqli_query($connect,"SELECT * FROM $tablename WHERE (sample_rec_date  = '$hufdt') AND clinical_correlation = 'Yes'")or die(mysqli_error($connect));
