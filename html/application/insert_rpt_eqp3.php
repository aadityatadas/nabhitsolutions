<?php
	...
	{	
		...
		if($_FILES["rpt_rpt3"]["name"] != '')
		{
			...
			$qry2 = "SELECT eqp_upld_id FROM tbl_eqp_upld ORDER BY eqp_upld_id DESC";
				$result2 = mysqli_query($connect, $qry2);
				$row2=mysqli_fetch_array($result2);
				$id = $row2['eqp_upld_id'];
				$did2 = $id+1;
				
				$sql2 = "INSERT INTO tbl_eqp_upld(eqp_upld_id ,eqp_id,eqp_srno ,eqp_upld_doc) 
				VALUES('$did2','$cid','3','$imagetw')";  
				
				mysqli_query($connect, $sql2);	
			$sql1 = "UPDATE tbl_eqp_mast SET amcs_img = '$imageth' WHERE eqpid = '$cid'";  
