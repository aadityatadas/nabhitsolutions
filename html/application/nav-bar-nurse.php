  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color: #337ab7;">
          ...
          <span style="font-size: 15px; color: white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NABH For Hospitals And Healthcare Providers.
            ...
            <div class="navbar-default sidebar" role="navigation" style="border-color:#333; font-size: 13px; color: #e6eeff; font-weight: 100; font-family:sans-serif; line-height: 2.428571;" onMouseOver="this.style.color='black'"
             ...
             <li style="border-bottom: 0px;"  class="w3-bar">
              <a href="dashboard-nur.php" style="color:#e6eeff; border:5px; background-color: #ffffff00;"><i class="fa fa-dashboard"></i>&nbsp;  Dashboard</a>
            </li>   
          ...
          <!--   <li style="border-bottom: 0px; ">
            ...
            <li style="border-bottom: 0px; ">
             ...
             <li style="border-bottom: 0px; ">
              <a href="#" style="color: #e6eeff; background-color:   #261a0d;"  ><i class="fa fa-home fa-fw"></i> Nurse Related Indicator</a>
            </li>


            <li style="border-bottom: 0px; ">
              <a href="ipd_feedback_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> IPD Feedback Form</a>
            </li>

           
            <li style="border-bottom: 0px; ">
              <a href="vent_ass_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Ventilator Associated &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pnemonia</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="cat_ass_uti_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Catheter Associated UTI</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="cent_line_ass_bsi_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Central Line Associated BSI</a>
            </li>
           ...
           <!--  <li style="border-bottom: 0px; ">
            ...
            <li style="border-bottom: 0px; ">
              <a href="int_asst_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i>  Initial Assessment Register</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="ipd_waittm_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> IPD Discharge Register</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="blood_trasfusion_event_nurs.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Blood Trasfusion Register</a>
            </li>
            ...
            <li style="border-bottom: 0px; ">
              <a href="care_relate_event_nurs.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i>  Nursing Care Register</a>
            </li>
...
<!-- 
 ...
 -->
              ...
              <li style="border-bottom: 0px; ">
                <a href="icu_register_ipd_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> ICU Register</a>
              </li>


              <li style="border-bottom: 0px; ">
                <a href="emrgncy_register_ipd_form_nurs.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Emergency Register</a>
              </li>
 ...
 -->
           ...
           <!--  <li style="border-bottom: 0px; ">
            ...
            <!-- <li style="border-bottom: 0px; ">
              <a href="chart_det_nurs.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Control Charts </a>
            </li>
