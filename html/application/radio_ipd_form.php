...
<br>
     <div id="newDatatoSave" >
		...
		<input type="hidden" name="radio_ipd_id_or" id="radio_ipd_id_or" />										<button accesskey="s" type="submit" name="action" id="action" class="btn btn-primary pull-right" />Submit ( Alt + s )</button>
											</div>
											<div class="col-lg-6">	
...
html +='<div class="col-lg-12"><label class="col-lg-4">Name of LAB Personnel</label><div class="col-lg-7"><input type="text" autocomplete="off" name="Remarksold[]" id="Remarksold'+i+'" placeholder="name of LAB personnel" class="form-control" value="'+data.remarks_old[i]+'" readonly /></div></div>';
          html +='<div class="col-lg-4"></div><div class="col-lg-2"><button type="button" name="edit" id="'+data.radio_ipd_extra_id[i]+'"  class="btn btn-primary edit_data">Edit Record No. '+j+'</button></div></div>';
