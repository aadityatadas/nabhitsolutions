<script type="text/javascript"> 
    $(document).ready(function () {
        ...
        <div class="navbar-default sidebar" role="navigation" style="border-color:#333; margin-top: 50px;">
                ...
                <div class="sidebar-nav navbar-collapse" style="background-color:#222d32;">
                    <ul class="nav" id="side-menu" >
                       ...
                       <!-- <li>
                            <a href="dashboard.php"><i class="fa fa-home fa-fw"></i><b style="color:#0066cc;"> Front Office/Reception </b> </a>
                        </li>
						<li>
                            <a href="hosp_util_form.php"><i class="fa fa-renren fa-fw"></i> IPD Register</a>
                        </li>
                        <li>
                       ...
                       <!--<li>
						...
						<li>
                         ...
                         <li style="border-bottom: 0px; ">
                            <a href="dashboard-mat.php" style="color:#999; "><i class="fa fa-home fa-fw"></i> <b> Infection Control  Nurse's / &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matron</b> </a>
                        
                         <li style="border-bottom: 0px; ">
                            <a href="care_relate_event1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Care related events</a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="vent_ass_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Ventilator Associated Pnemonia</a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="cat_ass_uti_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Catheter Associated UTI</a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="cent_line_ass_bsi_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Central Line Associated BSI</a>
                        </li>
                        <li style="border-bottom: 0px; ">
                            <a href="int_asst_form2.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Initial Assessment Time</a>
                        </li>

						 <li style="border-bottom: 0px; ">
                            <a href="ipd_waittm_form2.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> IPD Discharge Time </a>
                        </li>
						 <li style="border-bottom: 0px; ">
                            <a href="blood_trasfusion_event2.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Blood Trasfusion Events</a>
                        </li>
                           <li style="border-bottom: 0px; ">
                            <a href="ipd_feedback_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> IPD Feedback </a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="surg_site_inf_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Surgical Site Infection Form</a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="needle_prick_inj_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Occupational Exposure/Needle &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Prick Injury</a>
                        </li>
						<li style="border-bottom: 0px; ">
                            <a href="sentinel_event_form1.php"  style="color:#999; "><i class="glyphicon glyphicon-record"></i> Sentinel Event - Surgical and  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Anesthetia Events</a>
                        </li>
