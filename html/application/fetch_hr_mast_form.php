...
foreach($result as $row)
{
	$centid = $row["hrid"];
	$sub_array = array();
	$sub_array[] = '<a style="cursor:pointer;" title="Click here to edit" id="'.$row["hrid"].'" class="update" ><i style="color:darkblue;" class="fa fa-edit fa-fw"></i></a>&nbsp;&nbsp;<a style="cursor:pointer;" title="Click here to delete" id="'.$row["hrid"].'" class="delete" ><i style="color:red;" class="fa fa-trash-o fa-fw"></i></a>';
	
	$sub_array[] = $row["hrid"];
	$sub_array[] = $row["hr_staff"];
	$sub_array[] = $row["hr_empcode"];
	$sub_array[] = $row["hr_reg_no"];
	$sub_array[] = $row["hr_desig"];
	$sub_array[] = $row["hr_dept"];
	$sub_array[] = $row["hr_datej"];
	$sub_array[] = $row["hr_emp_type"];
