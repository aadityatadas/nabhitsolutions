	...
	<div id="wrapper">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo number_format($tabs1,2);?>%</h3>

              <p>Employee Absentism Rate</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo number_format($tabs2,2);?>%</h3>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo number_format($tabs3,2);?>%</h3>

              <p>Employee Griviences rate</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo number_format($tabs4,2);?>%</h3>

              <p>Needle Prick Injury Rate</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo number_format($tabs5,2);?>%</h3> 

              <p>Occupational Exposure rate</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo number_format($tabs6,2);?>%</h3>

              <p>% of complete HR files</p>
            </div>
            <div class="icon">
                <i class="ion ion-person-add"></i>
            </div>
