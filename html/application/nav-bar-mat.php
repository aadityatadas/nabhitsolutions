...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color: #337ab7;">
          ...
          <span style="font-size: 15px; color: white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NABH For Hospitals And Healthcare Providers.
            ...
            <div class="navbar-default sidebar" role="navigation" style="border-color:#333; font-size: 13px; color: #e6eeff; font-weight: 100; font-family:sans-serif; line-height: 2.428571;" onMouseOver="this.style.color='black'"
             ...
             <li style="border-bottom: 0px;"  class="w3-bar">
              <a href="dashboard-mat.php" style="color:#e6eeff; border:5px; background-color: #ffffff00;"><i class="fa fa-dashboard"></i> &nbsp;Dashboard</a>
            </li>   
        ...
        <!--     <li style="border-bottom: 0px; ">
            ...
            <li style="border-bottom: 0px; ">
             ...
             <li style="border-bottom: 0px; ">
              <a href="#" style="color: #e6eeff; background-color:   #261a0d;"  ><i class="fa fa-home fa-fw"></i> Infection Control Nurse's/ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matron</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="ipd_feedback_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> IPD Feedback Form</a>
            </li>

           

            <li style="border-bottom: 0px; ">
              <a href="vent_ass_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Ventilator Associated &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pnemonia</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="cat_ass_uti_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Catheter Associated UTI</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="cent_line_ass_bsi_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Central Line Associated BSI</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="surg_site_inf_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Surgical Site Infection &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Register</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="needle_prick_inj_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;" class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Occupational Exposure/<p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Needle Prick Injury</p></a>
            </li>
           ...
           <!--  <li style="border-bottom: 0px; ">
            ...
            <li style="border-bottom: 0px; ">
              <a href="int_asst_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i>  Initial Assessment Register</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="ipd_waittm_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> IPD Discharge Register</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="blood_trasfusion_event_mat.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Blood Trasfusion Register</a>
            </li>
 ...
 -->
            <li style="border-bottom: 0px; ">
              <a href="care_relate_event_mat.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Nursing Care Register</a>
            </li>
...
<!-- 
             ...
             <li style="border-bottom: 0px; ">
              <a href="sentinel_event_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i>  Sentinel Event - Surgical and &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Anesthetia Events</a>
             </li>
 ...
 -->
              <li style="border-bottom: 0px; ">
                <a href="emrgncy_register_ipd_form_mat.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Emergency Register</a>
              </li>
 ...
 -->
           ...
           <!--  <li style="border-bottom: 0px; ">
            ...
            <!-- <li style="border-bottom: 0px; ">
              <a href="chart_det_mat.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Control Charts </a>
            </li> -->
