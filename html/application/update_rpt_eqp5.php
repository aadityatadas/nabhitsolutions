<?php
	...
	{	
		...
		{
			$qry=mysqli_query($connect,"SELECT eqp_repair_img FROM tbl_eqp_indic WHERE eqp_id = '$cid'")or die(mysqli_error($connect));
			...
			$qry2 = "UPDATE tbl_eqp_indic SET eqp_repair_img = '$imagefv' WHERE eqp_id = '$cid'";
