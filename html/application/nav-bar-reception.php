                ...
                <div class="sidebar-nav navbar-collapse" style="background-color:#222d32;">
                    <ul class="nav" id="side-menu" >
                      ...
                      <li style="border-bottom: 0px; ">
                            <a href="dashboard-reception.php" style="color:#999; "><i class="fa fa-home fa-fw"></i><b> Front Office/Reception </b> </a>
                        </li>

						<li style="border-bottom: 0px; ">
                             <a href="hosp_util_form1.php" style="color:#999; "><i class="glyphicon glyphicon-record"></i> Hospital Utilization</a>
                         </li>

                       <li style="border-bottom: 0px; ">
                             <a href="opd_waittm_form_det1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> OPD Waiting Time Form</a>
                       </li>

                         <li style="border-bottom: 0px; ">
                             <a href="bed_occup_form1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Bed Occupancy Form</a>
                        </li>

                        <li style="border-bottom: 0px; ">
                            <a href="opd_feedback_form1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> OPD Feedback Form</a>
                        </li>
                        	<!--<li>
						...
						<li>
                            <a href="blood_trasfusion_event.php"><i class="fa fa-renren fa-fw"></i> Blood Trasfusion Events</a>
                                    ...
                                    <li>
                            <a href="dashboard.php"><i class="fa fa-home fa-fw"></i><b style="color:#0066cc;">  Nurse's Related Indicator</b> </a>
                        </li>
