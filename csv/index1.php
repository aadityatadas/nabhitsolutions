...
<div class="container">
	...
	<button type="button" class="btn btn-secondary"><a href="https://nabhbuddy.com/nabhslsh/hms/test6/application/opd_feedback_form.php"><h4 style="color:#ffffff;">Back</h4></a></button>
	<!--<div class="row">
		<div class="col-sm-3">
...
<body>
	...
	<div class="d-flex justify-content-center">
		<div class="card mt-5 col-md-4 animated bounceInDown myForm">
			...
			<div class="card-body">
				<form method="POST" action="import1.php" enctype="multipart/form-data">
				<div class="form-group">
					<label for="file">File:</label>
					<input type="file" id="file" name="file">
				</div>
		...
		<a href="https://nabhbuddy.com/hms/csv/tbl_opd.csv" ><h4 style="color:#ffffff;">Demo csv file download Click Here!</h4></a>
			</div>
