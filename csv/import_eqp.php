	...
	if(isset($_POST['import'])){
		...
		if(!empty($_FILES['file']['name'])){
			...
			//$date2=	date('Y-m-d H:i:s', strtotime($var1));
						...
						//$sql = "INSERT INTO tbl_hr_mast (hr_staff,hr_empcode,hr_desig,hr_deptp,hr_datej,hr_ctstat, hr_ctstat_det,hr_recd) VALUES ('".$impData[0]."', '".$impData[1]."', '".$impData[2]."','".$impData[3]."', '".$impData[4]."', '".$impData[5]."','".$impData[6]."', '".$impData[7]."')";
$sql = "INSERT INTO `tbl_eqp_mast`( `eqp_name`, `eqp_type`, `eqp_idno`, `eqp_idno_img`, `eqp_srno`, `eqp_model`, `eqp_make`, `eqp_dtpur`, `eqp_dtins`, `eqp_dtins_img`, `eqp_wty1`, `eqp_wty2`, `eqp_psch1`, `eqp_psch2`, `eqp_psch3`, `eqp_psch4`, `eqp_csch1`, `eqp_csch2`, `eqp_csch_img`, `eqp_cond`, `eqp_lic`, `eqp_lic_img`, `eqp_recd`) VALUES ('".$impData[0]."', '".$impData[1]."', '".$impData[2]."','".$impData[3]."', '".$impData[4]."', '".$impData[5]."','".$impData[6]."', '".$impData[7]."', '".$impData[8]."', '".$impData[9]."', '".$impData[10]."', '".$impData[11]."', '".$impData[12]."', '".$impData[13]."', '".$impData[14]."', '".$impData[15]."', '".$impData[16]."', '".$impData[17]."', '".$impData[18]."', '".$impData[19]."', '".$impData[20]."', '".$impData[21]."', '".$impData[22]."', '".$impData[23]."')";
