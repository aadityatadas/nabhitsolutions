	...
	if(isset($_POST['import'])){
		...
		if(!empty($_FILES['file']['name'])){
			...
			$date2=	date('Y-m-d H:i:s', strtotime($var1));
						...
						$sql = "INSERT INTO tbl_opdwttm (opdwttm_pname, opdwttm_uhid,opdwttm_opd, opdwttm_drsp, opdwttm_dttmr,opdwttm_dttmds, opdwttm_opdwttm, opdwttm_recd) VALUES ('".$impData[0]."', '".$impData[1]."', '".$impData[2]."','".$impData[3]."', '".$date1."', '".$date2."','".$impData[6]."', '".$impData[7]."')";
