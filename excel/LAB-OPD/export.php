...
<table class="table" style="width:100%" border="0" style="border: 1px solid" >  
           <tr>  
              <th colspan="24">
                 ...
                 <h3 style="text-align: center; text-decoration: underline;">Laboratory Indicator (OPD)</h3>
              </th>
...
WHERE DATE(sample_rec_time_date) = '".$value."'";
...
a.remarks
 ...
 FROM tbl_lab_opd_extra as a
LEFT JOIN tbl_lab_opd ON a.tbl_lab_opd_id = tbl_lab_opd.lab_opd_id
LEFT JOIN tbl_opdwttm ON tbl_opdwttm.opdwttm_id = tbl_lab_opd.tbl_opdwttm_id WHERE DATE(a.sample_rec_time_date) = '".$value."' ";  
