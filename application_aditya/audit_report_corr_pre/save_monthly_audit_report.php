...
$tbl='tbl_monthly_audit_reports';
$q="DELETE  FROM $tbl  WHERE audit_date_month_year = '".$_POST["report_name_id"]."' AND audit_name='".$_POST["report_name"]."'";
...
$data['audit_date_month_year']=$_POST['report_name_id'];
...
$data['created_by']=	$ses;
		...
		if(!empty($result))
		{
			echo 'Corrective & Preventive Action Submitted Successfully';
		}

	} else{
		echo 'Corrective & Preventive Action Not Saved ';
	}
