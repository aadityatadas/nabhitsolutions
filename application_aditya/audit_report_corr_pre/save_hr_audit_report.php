...
$tbl='tbl_hr_audit_reports';
$q="DELETE  FROM $tbl  WHERE tbl_hr_audit_date_id = '".$_POST["report_name_id"]."' AND audit_name='".$_POST["report_name"]."'";
...
$data['tbl_hr_audit_date_id']=$_POST['report_name_id'];
