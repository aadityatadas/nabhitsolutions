<?php
	...
	$qry = "SELECT DISTINCT month_id FROM tbl_audit_hh3";
	...
	$dArry[1] = array(0=>'Education regarding NS1 prevention');
	$dArry[2] = array(0=>'Using devices with safety features');
	$dArry[3] = array(0=>'Available of appropriate sharp containers');
	$dArry[4] = array(0=>'Sharp container is Puncture resistant');
	$dArry[5] = array(0=>'Sharp container is Leak proof');
	$dArry[6] = array(0=>'Sharp container is Sharps inaccessible after they are put
	inside the container');
	$dArry[7] = array(0=>'Placement of the sharp container accessible');
	$dArry[8] = array(0=>'Placement of the sharp container Maintained upright');
	$dArry[9] = array(0=>'Placement of the sharp container Not allowed to over fill');
	$dArry[10] = array(0=>'Placement of the sharp container Lid/cap to close the container before
	transport present');
	$dArry[11] = array(0=>'Waste containers has bio hazard  label and Other documentation');
	$dArry[12] = array(0=>'Absence of visible sharps in red bag');
	$dArry[13] = array(0=>'No manual sorting of sharps');
	$dArry[14] = array(0=>'There is no re-use of syringes and needles');
	$dArry[15] = array(0=>'No recapping of needles');
	$dArry[16] = array(0=>'Users trays to carry sharps');
	$dArry[17] = array(0=>'All staffs are immunized against Hepatitis B');
	$dArry[18] = array(0=>'Housekeeping staff are wearing appropriate PPE while transporting sharp waste');
        ...
        <div id="page-wrapper">
                    ...
                    <div class="panel panel-primary">
		                    	 ...
		                    	 <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$tot= "SELECT COUNT(*) as total FROM tbl_audit_hh3 WHERE year(created) = '$yr'";
														...
														$qrycomp = "SELECT COUNT(*) as comp FROM tbl_audit_hh3 WHERE sign!='' AND year(created) = '$yr' ";
																$rescomp = mysqli_query($connect, $qrycomp);
																$rowcomp=mysqli_fetch_assoc($rescomp);
																// echo $rowcomp['comp'];
																											

														$qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_audit_hh3 WHERE sign='' AND year(created) = '$yr' ";
						...
						<div class="box" id="bx1">
							<div id="adm">
								...
								<div class="col-lg-12">
									<label class="col-md-12" style="color: #333; background-color: #9ac6eb!important; border-color: #9ac6eb!important; text-align: center; padding:10px;"> Sharp Safety Audit </label>
									<div class="col-lg-12">
										<table class="table table-bordered">
													<thead>
														<tr>
															<th>sr.no</th>
															<th width="30%"><strong>Sharp Safety Audit
															<th>Yes</th>
															<th>No</th>
															<th>NA</th>
															<th>Comment</th>
			...
			<textarea name="arrVal[<?= $n ?>][2]" rows="2" id="cmt<?= $n ?>" cols="40"></textarea></td>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-9">
												<input type="text" autocomplete="off" name="sign" id="sign" 
												 ...
												 <input type="hidden" name="tbl" value="tbl_audit_hh3">
											</div>
                        ...
                        <div class="col-lg-12" style="text-align:center">
								<form method="post" action="audit_hh/hic3Pdf.php"  target="print_popup"  onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
									<div class="panel-heading">
										...
										<input type="hidden" name="tblname" value="tbl_audit_hh3">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p style="text-align: center;"><b><font color="#000000">Sharp Safety Audit</font></b></p>
 ...
 <script>
    	...
    	$(document).on('click', '#myModel', function(){
          ...
          //alert(uid);
            ...
            $.ajax({
                method:"POST",
				url: "audit_hh/hic3Excel.php",
				data:{user_id:uid,tbl:'tbl_audit_hh3',ptbl:'ptbl'},
                cache: false,
	...
	$(document).ready(function() {
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				...
				method:"POST",
				data:{user_id:user_id,tbl:'tbl_audit_hh3'},
				dataType:"json",
				success:function(data)
				{
					$('#bx1').show('fast');
