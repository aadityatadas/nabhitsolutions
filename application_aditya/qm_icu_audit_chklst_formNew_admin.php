		                    	 ...
		                    	 <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$tot= "SELECT COUNT(*) as total FROM tbl_icu_checkstnew WHERE year(audit_date) = '$yr'";
														...
														$qrycomp = "SELECT COUNT(*) as comp FROM tbl_icu_checkstnew WHERE name_sign!='' AND year(audit_date) = '$yr' ";
																$rescomp = mysqli_query($connect, $qrycomp);
																$rowcomp=mysqli_fetch_assoc($rescomp);
																// echo $rowcomp['comp'];
																											

														$qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_icu_checkstnew WHERE name_sign=''   AND year(audit_date) = '$yr' ";
