...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_blood_fusion WHERE year(bld_dtreq) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_blood_fusion  WHERE (bld_tat!='' AND bld_tat!='00:00') AND year(bld_dtreq) = '$yr' ";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_blood_fusion  WHERE (bld_tat='' OR bld_tat='00:00')AND year(bld_dtreq) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartBTRE"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Blood Trasfusion Related Events'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartBTRE', 'clicknode', {
