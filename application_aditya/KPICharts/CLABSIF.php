    ...
    .zc-ref {
      display: none;
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_centrl_line_assoc WHERE year(cent_bs_dticlc) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_centrl_line_assoc WHERE (cent_bs_tcld!='' AND cent_bs_tcld!='0')AND year(cent_bs_dticlc) = '$yr'";
                                $rescomp= mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_centrl_line_assoc WHERE (cent_bs_tcld='' OR cent_bs_tcld='0')AND year(cent_bs_dticlc) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartCLABSIF"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Central Line Associated Blood Stream Infection Form'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartCLABSIF', 'clicknode', {
