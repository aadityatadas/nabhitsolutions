...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_surg_site_infec WHERE year(surg_dtos) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_surg_site_infec WHERE (surg_nsurg!='' AND surg_nsurg!='0') AND year(surg_dtos) = '$yr'";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_surg_site_infec WHERE (surg_nsurg='0' OR surg_nsurg='') AND year(surg_dtos) = '$yr' ";
...
<div class="col-lg-12">
  ...
  <div id="myChartSSIR"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Surgical Site Infection Register'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartSSIR', 'clicknode', {
