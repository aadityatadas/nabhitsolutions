...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_cath_assoc_uti WHERE year(cath_uti_iuc) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_cath_assoc_uti WHERE (cath_uti_tcd!='' AND cath_uti_tcd!='0')AND year(cath_uti_iuc) = '$yr'";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_cath_assoc_uti WHERE (cath_uti_tcd='0' OR cath_uti_tcd=' ') AND year(cath_uti_iuc) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartCAUTI"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Cather Associated Unrinary Tract Infection'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartCAUTI', 'clicknode', {
