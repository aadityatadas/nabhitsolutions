...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_need_pif WHERE year(needp_dttm) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_need_pif WHERE (needp_mod_inj!='' AND needp_mod_inj!='0') AND year(needp_dttm) = '$yr'";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp= "SELECT COUNT(*) as notcomp FROM tbl_need_pif WHERE( needp_mod_inj=' ' OR needp_mod_inj='0') AND year(needp_dttm) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartNPI"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Needle Prick Injury Register'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartNPI', 'clicknode', {
