...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_pharmcy_register WHERE year(vendor) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM tbl_pharmcy_register WHERE (item_no!='' AND item_no!='0') AND year(vendor) = '$yr'";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_pharmcy_register WHERE (item_no='' OR item_no='0') AND year(vendor) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartPR"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Pharmacy Register'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartPR', 'clicknode', {
