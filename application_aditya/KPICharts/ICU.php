...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_icu_register_ipd WHERE year(date_of_return_in_icu) = '$yr'";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp  FROM tbl_huf LEFT JOIN tbl_icu_register_ipd ON tbl_huf.huf_id = tbl_icu_register_ipd.tbl_huf_id WHERE sign!='' AND year(date_of_return_in_icu) = '$yr' ";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_huf LEFT JOIN tbl_icu_register_ipd ON tbl_huf.huf_id = tbl_icu_register_ipd.tbl_huf_id WHERE sign='' AND year(date_of_return_in_icu) = '$yr' ";
...
<div class="col-lg-12">
  ...
  <div id="myChartICU"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of ICU Register Form'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartICU', 'clicknode', {
