...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM tbl_opd LEFT JOIN tbl_opdwttm  ON tbl_opdwttm.opdwttm_id= tbl_opd.opd_id WHERE year(opdwttm_dttmds) = '$yr'";
...
<div class="col-lg-12">
  ...
  <div id="myChartopdfeedback"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of OPD Feedback'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartopdfeedback', 'clicknode', {
