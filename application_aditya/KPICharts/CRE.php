...
<?php
                          ...
                          $qry = "SELECT COUNT(*) as total FROM  tbl_care_evt WHERE year(care_dtpli) = '$yr' ";
                            ...
                            $qrycomp = "SELECT COUNT(*) as comp FROM  tbl_care_evt   WHERE  (care_tmpli!='' AND care_tmpli!='00:00') AND year(care_dtpli) = '$yr' ";
                                $rescomp = mysqli_query($connect, $qrycomp);
                                $rowcomp=mysqli_fetch_assoc($rescomp);
                                // echo $rowdis['discharge'];
                                                      

                            $qrynotcomp = "SELECT COUNT(*) as notcomp FROM  tbl_care_evt   WHERE (care_tmpli=' ' OR care_tmpli='00:00')AND year(care_dtpli) = '$yr' ";
...
<div class="col-lg-12">
  ...
  <div id="myChartCRE"><a class="zc-ref" href="https://www.zingchart.com">Powered by ZingChart</a></div>
  <script>
    ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"];
    var myConfig = {
      type: "pie",
      title: {
        text: 'Performance Of Care Related Events'
      },
      plot: {
        valueBox: {
          placement: 'out',
    ...
    zingchart.label_click = function(e) {
      console.log(e)
      zingchart.exec('myChartCRE', 'clicknode', {
