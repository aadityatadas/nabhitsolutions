								...
								<form method="post" action="audit_hh/hic23Excel.php" enctype="multipart/form-data">
									...
									<div class="col-lg-12">
										<label class="col-md-2">Quarter</label>
											...
											<div class="col-lg-4">
												<select name="qut1" id="qut1" onchange="getAllAudit(this.value);" class="form-control">
									...
									<div class="col-lg-12" id="tblRepalce">
										...
										<div class="col-lg-12">
											<div class="col-lg-6">	
												...
												<button  style="color: white;font-weight: bold;" name="excel" id="excel" class="btn btn-success pull-right">Export</button>
											</div>
										</div>
