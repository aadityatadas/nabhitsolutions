...
<body>
                          ...
                          ?>
                                         ...
                                         <div id='myCharttot'><a class="zc-ref" href="https://www.zingchart.com/">Charts by ZingChart</a></div>
  ...
  series: [
    {
      values: [<?php echo $total1+$total2+$total1;?>],
      csize: "15%",     //Needle Width
      size: "100%",    //Needle Length
      'background-color': "blue"  //Needle Color

    },
    {
      values: [<?php echo $comp1+$comp2+$comp1;?>],
      csize: "15%",
      size: "75%",
      'background-color': "green"
    },
    {
      values: [<?php echo $notcomp1+$notcomp2+$notcomp1;?>],
      csize: "15%",
      size: "70%",
