	 ...
	 <div id="wrapper">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo $mineqp;?>&nbsp;<small style="color: white;">Hrs.</small></h3>

              <p>Equipement Breakdown Time</p>
            </div>
            <div class="icon">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo number_format($tt5,2);?>&nbsp;<small style="color: white;">%</small></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p>Total No.of Equipment Under AMC</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Total No. of Equipment Under Calibration</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $rsBreak;?></h3>

              <p>Total No of breakdowns</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php echo ($hours);?> <small style="color: white";> Days </small></h3> 
