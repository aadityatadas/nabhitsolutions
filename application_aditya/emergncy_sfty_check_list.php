<?php
	...
	include"location_checklist.php";
	 include "emergncy_sfty_chklist/headings.php";
...
<script type="text/javascript">
	...
	function ()
	{
	$('#hosp').load('emergncy_sfty_chklist/emergncy_sfty_chklst_count.php').fadeIn("slow");
				...
				<div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="padding:7px;">
                            Emergency Prepareness Safety Checklist
							...
							<div class="col-lg-12">
								<label class="col-md-12" style="color: #333; background-color: #9ac6eb!important; border-color: #9ac6eb!important; text-align: center; padding:10px;">  <?=$rowHead[0];?></label>
									...
									<div class="col-lg-2" ><?=$rowHead[0];?></div>
											<div class="col-lg-4">
												<select type="text" 
												name="emergncy_codes_numbers_yn" 
												id="emergncy_codes_numbers_yn" 
												onChange="LoadData();" 
												class="form-control" />
											...
											<div class="col-lg-4">
												<select type="text" 
												name="emergncy_codes_numbers_loc" 
												id="emergncy_codes_numbers_loc" onChange="LoadData();" 
												class="form-control" />
                              ...
                              <?php endforeach;  ?> 
                               <!-- <option value="Yes">Yes</option>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-10">
												<input type="text" 
												name="emergncy_codes_numbers_rmrk" 
												id="emergncy_codes_numbers_rmrk" 
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="roles_emrgy_cards_yn" 
												id="roles_emrgy_cards_yn" onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="roles_emrgy_cards_loc" 
												id="roles_emrgy_cards_loc" onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
								<?php   foreach($checklist_locations as $loc): ?>
                                ...
                                <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="roles_emrgy_cards_rmrk" 
												id="roles_emrgy_cards_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="emergncy_code_alarm_yn" 
												id="emergncy_code_alarm_yn" 
											...
											<div class="col-lg-4">
												<select type="text" 
												name="emergncy_code_alarm_loc" 
												id="emergncy_code_alarm_loc" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
							<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?> 
                               <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="emergncy_code_alarm_rmrk" 
												id="emergncy_code_alarm_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="mock_drills_check_yn" 
												id="mock_drills_check_yn" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="mock_drills_check_loc" 
												id="mock_drills_check_loc" 
												onChange="LoadData();" 
												class="form-control" />
                              ...
                              <?php endforeach;  ?>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="mock_drills_check_rmrk" 
												id="mock_drills_check_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
											</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-4">
												<select type="text" 
												name="emergncy_equipment_chklst_yn" 
												id="emergncy_equipment_chklst_yn" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
											...
											<div class="col-lg-4">
												<select type="text" 
												name="emergncy_equipment_chklst_loc" 
												id="emergncy_equipment_chklst_loc" 
												onChange="LoadData();" 
												class="form-control" />
													<option value="">Select</option>
								<?php   foreach($checklist_locations as $loc): ?>
                              ...
                              <?php endforeach;  ?>  <!-- <option value="Yes">Yes</option>
											...
											<div class="col-lg-10">
												<input type="text" 
												name="emergncy_equipment_chklst_rmrk" 
												id="emergncy_equipment_chklst_rmrk" 
												class="form-control" 
												placeholder="Remarks" />
											</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p style= colspan=6 height="28" align="center" valign=middle><b><font size=6 color="#000000">Emergency Prepareness Cheklist</font></b></p>
            </div>
...
<script>
    $('#exampleModal').on('show.bs.modal', function (event) {
          ...
          var dataString = 'id=' + recipient;
            ...
            $.ajax({
                type: "GET",
                url: "emergncy_sfty_chklist/editdata.php",
                data: dataString,
                cache: false,
...
<script>	
	$(document).ready(function() {
		...
		$('#add_btn').click(function(){
			...
			$('#sr').load("emergncy_sfty_chklist/load_emergncy_sfty_chklst.php");
			$('#nm').text("New Receipt");
		});
		...
		var dataTable = $('#dataTables-example').DataTable({
			...
			"order":[],
			"ajax":{
				url:"emergncy_sfty_chklist/fetch_all_emergncy_sfty_chklst_form.php",
				type:"POST"
			},
			"columnDefs":[
				{
		...
		$(document).on('submit', '#user_form', function(event){
			...
			if(item_no != '')
			{
				if(confirm("Are you sure you want to Submit this?"))
				{
					...
					$.ajax({
						url:"emergncy_sfty_chklist/insert_emergncy_sfty_chklst_form.php",
						method:'POST',
		...
		$(document).on('click', '.update', function(){
			...
			//$('#md2').show('fast');
			$.ajax({
				url:"emergncy_sfty_chklist/fetch_single_emergncy_sfty_chklst_form.php",
				method:"POST",
				...
				success:function(data)
				{
					...
					$('#emergncy_codes_numbers_yn').val(data.emergncy_codes_numbers_yn);
					$('#emergncy_codes_numbers_loc').val(data.emergncy_codes_numbers_loc);
					$('#emergncy_codes_numbers_rmrk').val(data.emergncy_codes_numbers_rmrk);
					
					
                   $('#roles_emrgy_cards_yn').val(data.roles_emrgy_cards_yn);
				$('#roles_emrgy_cards_loc').val(data.roles_emrgy_cards_loc);
				$('#roles_emrgy_cards_rmrk').val(data.roles_emrgy_cards_rmrk);
			...
			$('#emergncy_code_alarm_yn').val(data.emergncy_code_alarm_yn);
			$('#emergncy_code_alarm_loc').val(data.emergncy_code_alarm_loc);
			$('#emergncy_code_alarm_rmrk').val(data.emergncy_code_alarm_rmrk);
			$('#mock_drills_check_yn').val(data.mock_drills_check_yn);
			$('#mock_drills_check_loc').val(data.mock_drills_check_loc);
			$('#mock_drills_check_rmrk').val(data.mock_drills_check_rmrk);
			$('#emergncy_equipment_chklst_yn').val(data.emergncy_equipment_chklst_yn);
			$('#emergncy_equipment_chklst_loc').val(data.emergncy_equipment_chklst_loc);
			$('#emergncy_equipment_chklst_rmrk').val(data.emergncy_equipment_chklst_rmrk);
		...
		$(document).on('click', '.delete', function(){
			...
			{
				$.ajax({
					url:"emergncy_sfty_chklist/delete_emergncy_sfty_chklst_form.php",
					method:"POST",
					data:{user_id:user_id},
					success:function(data)
					{
