...
<!-- 
            ...
            <li style="border-bottom: 0px; ">
             ...
             <li style="border-bottom: 0px; ">
              ...
              <li style="border-bottom: 0px; ">
               <a href="pharmcy_register_form.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Pharmacy Registration</a>
             </li> -->
              <li style="border-bottom: 0px; ">
                <a href="dashboard-radiology.php" style="color:#999; "><i class="fa fa-home fa-fw"></i><b> Radiology </b> </a>
              </li>          
             ...
             <li style="border-bottom: 0px; ">
              <a href="radio_ipd_form1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Radiology Indicator</a>
             </li>
             ...
             <li style="border-bottom: 0px; ">
              <a href="radio_opd_form1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Radiology Indicator</a>
            </li>
            <!--<li>
