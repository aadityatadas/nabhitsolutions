                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_icu_register_ipd WHERE year(date_of_return_in_icu) = '$yr'";
														...
														$qrydis = "SELECT COUNT(*) as comp  FROM tbl_huf LEFT JOIN tbl_icu_register_ipd ON tbl_huf.huf_id = tbl_icu_register_ipd.tbl_huf_id WHERE sign!='' AND year(date_of_return_in_icu) = '$yr' ";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_huf LEFT JOIN tbl_icu_register_ipd ON tbl_huf.huf_id = tbl_icu_register_ipd.tbl_huf_id WHERE sign='' AND year(date_of_return_in_icu) = '$yr' ";
										...
										<div id="Old_Data" ></div>
											<div class="col-lg-12">
												...
												<div class="col-lg-2" id="addButton">
												 <button style="color:white;" type="button" name="add" id="add" class="btn btn-info">Add New Record</button>
												</div>
											</div>
				...
				{  
					...
					if(data.oldDataCount>0){
						...
						for(var i=0; i < data.oldDataCount; i++){
							...
							html +='<div class="col-lg-2"><button type="button" name="edit" id="'+data.icu_ipd2_id[i]+'"  class="btn btn-info edit_data">Edit Record No. '+j+'</button></div></div>';
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title panel panel-info"> <div class="panel-heading" style="padding:7px;">ICU Register Form</div></h4>  
                </div>
