		                    	 ...
		                    	 <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$tot= "SELECT COUNT(*) as total FROM tbl_audit_hh18 WHERE year(created) = '$yr'";
														...
														$qrycomp = "SELECT COUNT(*) as comp FROM tbl_audit_hh18 WHERE sign!='' AND year(created) = '$yr' ";
																$rescomp = mysqli_query($connect, $qrycomp);
																$rowcomp=mysqli_fetch_assoc($rescomp);
																// echo $rowcomp['comp'];
																											

														$qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_audit_hh18 WHERE sign='' AND year(created) = '$yr' ";
