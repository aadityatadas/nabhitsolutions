                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_emrgncy_register_ipd WHERE year(date_of_patient_arrvl_at_emrgncy) = '$yr'";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_emrgncy_register_ipd WHERE (time_taken_for_initl_assmnt!='' AND time_taken_for_initl_assmnt!='00:00') AND  year(date_of_patient_arrvl_at_emrgncy) = '$yr' ";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp  FROM tbl_emrgncy_register_ipd  WHERE (time_taken_for_initl_assmnt='' OR time_taken_for_initl_assmnt='00:00' )AND  year(date_of_patient_arrvl_at_emrgncy) = '$yr'";
							...
							<div id="adm">
								<form method="post" id="user_form" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Return to Emergency</label>
											<div class="col-lg-2">	
												<select type="text" name="return_to_emergency" id="return_to_emergency" onChange="LoadData();" class="form-control" />
													<option value="">Select</option>
													<option value="Yes">Yes</option>
													<option value="No">No</option>
												</select>
                                ...
                                <div class="col-lg-12">
											...
											<div class="col-lg-2">
												<input type="text" autocomplete="off" name="date_of_retrn_to_emrgncy_dept_if_any" id="date_of_retrn_to_emrgncy_dept_if_any" placeholder="yyyy-mm-dd" class="form-control" />
											</div>
											<div class="col-lg-2">
												<input type="time" name="time_of_retrn_to_emrgncy_dept_if_any" id="time_of_retrn_to_emrgncy_dept_if_any" placeholder="hh:mm" class="form-control" />
											</div>
										</div>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-7">
												<input type="text" autocomplete="off" name="patients_comp_on_rtn_of_emrgncy" id="patients_comp_on_rtn_of_emrgncy" placeholder="Patient'S Complaint  On Return To Emergency	..." class="form-control" />
											</div>
										</div>	
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-7">
												<input type="text" autocomplete="off" name="sign" id="sign" placeholder="cmo or casualty nurse..." class="form-control"/>
											</div>
										</div>	
										</div>							
										<div id="Old_Data" ></div>
			...
			$.ajax({
				...
				{  
					...
					if(($('#date_of_patient_arrvl_at_emrgncy').val())==""){
						...
						$('#return_to_emergency').val(data.return_to_emergency);
						...
						if(data.oldDataCount>0){
						        ...
						        html += '<div class="col-lg-12"><label class="col-lg-4">Brought Dead</label><div class="col-lg-2"><select type="text" name="brought_deadold[]" id="brought_dead'+i+'" value="'+data.seven[i]+'" class="form-control" disabled><option value="'+data.seven[i]+'">'+data.seven[i]+'</option></select></div></div>';
						         ...
						         html += '<div class="col-lg-12"><label class="col-lg-4">Return to Emergency</label><div class="col-lg-2"><select type="text" name="return_to_emergencyold[]" id="return_to_emergency'+i+'" value="'+data.seven[i]+'" class="form-control" disabled><option value="'+data.seven[i]+'">'+data.seven[i]+'</option></select></div></div>';
						        ...
						        html +='<div class="col-lg-12"><label class="col-lg-4">Patient Complaint  On Return To Emergency </label><div class="col-lg-7"><input type="text" autocomplete="off" name="patients_comp_on_rtn_of_emrgncyold[]" id="patients_comp_on_rtn_of_emrgncy'+i+'" placeholder="Patient Complaint  On Return To Emergency..." value="'+data.ten[i]+'" class="form-control" readonly/></div></div>';
						         ...
						         html +='<div class="col-lg-12"><label class="col-lg-4">Return To The Emergency Department With In 72 Hours With Similar Presenting Complaint If Any</label><div class="col-lg-2"><select type="text" name="retn_of_emrgncyold[]" id="retn_of_emrgncy'+i+'" class="form-control" value="'+data.eleven[i]+'" disabled><option value="'+data.eleven[i]+'">'+data.eleven[i]+'</option></select></div><div class="col-lg-6"><input type="text" autocomplete="off" name="retn_of_emrgncy_resonold" id="retn_of_emrgncy_reson'+i+'"  value="'+data.thirteen[i]+'" placeholder="Give reason if Yes" class="form-control" disabled/></div>	</div>';
						          ...
						          html +='<div class="col-lg-2"><button type="button" name="edit" id="'+data.emrgncy_reg_ipd2_id[i]+'"  class="btn btn-info edit_data">Edit Record No. '+j+'</button></div></div>';
						          html +='</div>';
...
<script type="text/javascript">
	$(document).ready(function(){  
     ...
     if(divss>0){ alert("Please fill data In Present Record Feilds"); return false;}  
          ...
          html += '<div class="col-lg-12"><label class="col-lg-4">Return to Emergency</label><div class="col-lg-2"><select type="text" name="return_to_emergency1[]" id="return_to_emergency'+divcount+'" class="form-control" ><option value="">Select</option><option value="Yes">Yes</option><option value="No">No</option></select></div></div>';
        ...
        html +='<div class="col-lg-12"><label class="col-lg-4">Patient Complaint  On Return To Emergency </label><div class="col-lg-7"><input type="text" autocomplete="off" name="patients_comp_on_rtn_of_emrgncy1[]" id="patients_comp_on_rtn_of_emrgncy'+divcount+'" placeholder="Patient Complaint  On Return To Emergency..." class="form-control" required/></div></div>';
         ...
         html +='<div class="col-lg-12"><label class="col-lg-4">CMO or Casualty Nurse</label><div class="col-lg-6"><input type="text" autocomplete="off" name="sign1[]" id="sign'+divcount+'" placeholder="cmo or casualty nurse..." class="form-control"/></div>';

          html +='<div class="col-lg-2"><button style="color:white;" type="button" name="remove" id="'+divcount+'" class="btn btn-danger btn_remove ">Delete</button></div></div>';
      ...
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     ...
                     <h4 class="modal-title panel panel-info"> <div class="panel-heading" style="padding:7px;">Emergency Register Form  </div></h4>  
             ...
             <div class="col-lg-12">
         	 ...
         	 <div class="col-lg-12">
             	<label class="col-lg-12">Return to Emergency</label>
	            <div class="col-lg-6">
	             	<select type="text" name="return_to_emergencyEdit" id="return_to_emergencyEdit" onChange="LoadData();" class="form-control" />
			             <option value="">Select</option>
			             <option value="Yes">Yes</option>
			             <option value="No">No</option>
	         		</select>
 	...
 	$(document).on('click', '.edit_data', function(){ 
           ...
           $.ajax({  
                ...
                success:function(data){ 
					...
					$('#return_to_emergencyEdit').val(data.return_to_emergencyEdit);
