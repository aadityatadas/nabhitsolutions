				...
				<div class="col-lg-12">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="padding:7px;height: 140px;">
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_huf WHERE year(huf_dadm) = '$yr'";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_huf WHERE (int_tottm!=''AND int_tottm!='0') AND  year(huf_dadm) = '$yr' ";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_huf WHERE (int_tottm=' ' OR int_tottm='0')AND  year(huf_dadm) = '$yr'";
                           ...
                           <span style="box-shadow: 0 0 3px 1px rgba(0,0,0,.35);color:white;font-weight:bold;margin-right: 10px;" onclick="myFunction()" class="btn btn-info"><i class="fa fa-print"></i> Print</span>
