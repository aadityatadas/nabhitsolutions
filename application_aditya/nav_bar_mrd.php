          ...
          <span style="font-size: 15px; color: white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NABH For Hospitals And Healthcare Providers.
            ...
            <div class="navbar-default sidebar" role="navigation" style="border-color:#333; font-size: 13px; color: #e6eeff; font-weight: 100; font-family:sans-serif; line-height: 2.428571;" onMouseOver="this.style.color='black'"
             ...
             <li style="border-bottom: 0px;"  class="w3-bar">
              <a href="dashboard-mrdoffice.php" style="color:#e6eeff; border:5px; background-color: #ffffff00;"><i class="fa fa-dashboard"></i>&nbsp;  Dashboard</a>
            </li>   
 ...
 -->
            <li style="border-bottom: 0px; ">
              <a href="#" style="color: #e6eeff; background-color:   #261a0d; "><i class="fa fa-home fa-fw"></i> MRD Officer</a>
            </li>

            <li style="border-bottom: 0px; ">
              <a href="medi_records_indicator_mrd.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Medical Records Indicator</a>
            </li>
...
<!-- 
 ...
 -->
             ...
             <li style="border-bottom: 0px; ">
              <a href="form_indicator_mrd.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Form Indicators</b> </a>
             </li>
           ...
           <!--  <li style="border-bottom: 0px; ">
            ...
            <li style="border-bottom: 0px; ">
              <a href="chart_det_mrd.php" style="color: #e6eeff; background-color: #ffffff00;"  class="w3-hover-border-#272525 w3-hover-text-blue"><i class="fa fa-renren fa-fw"></i> Control Charts </a>
            </li>
