                          	  ...
                          	  <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$qry = "SELECT COUNT(*) as total FROM tbl_lab_ipd WHERE year(date_of_rep_gen) = '$yr'";
														...
														$qrydis = "SELECT COUNT(*) as comp FROM tbl_lab_ipd WHERE nam_of_test!='' AND year(date_of_rep_gen) = '$yr'";
																$resdis = mysqli_query($connect, $qrydis);
																$rowdis=mysqli_fetch_assoc($resdis);
																// echo $rowdis['discharge'];
																											

														$qrynotdis = "SELECT COUNT(*) as notcomp FROM tbl_lab_ipd  WHERE nam_of_test='' AND year(date_of_rep_gen) = '$yr'";
