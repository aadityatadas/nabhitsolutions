...
<br>
     <div id="newDatatoSave" >
		...
		<input type="hidden" name="radio_ipd_id_or" id="radio_ipd_id_or" />										<button accesskey="s" type="submit" name="action" id="action" class="btn btn-info pull-right" />Submit ( Alt + s )</button>
											</div>
											<div class="col-lg-6">	
