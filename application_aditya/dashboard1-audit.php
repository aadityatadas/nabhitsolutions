...
<body>
	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header"><a href="http://hospiexperts.com/asha/hms/nabh/dashboard.php" style="text-decoration:none;">Dashboard</a>&nbsp; &nbsp; &nbsp; Month : <?php echo date('M-Y');?></h4>
