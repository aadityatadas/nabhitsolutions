...
while($row = mysqli_fetch_array($result))
  {
   ...
   ';
    ...
    <tr>  
       ...
       <td align="center">'.$mr_having_incm_imp_const_per.'</td>  
       <td align="center">'.$mr_without_sign_init_ass_sheet_per.'</td>  
       <td align="center">'.$mr_without_sign_init_medictn_order_per.'</td>
       <td align="center">'.$mr_without_nursing_asst_per.'</td>  
       <td align="center">'.$mr_without_nutrition_asst_per.'</td>
       <td align="center">'.$mr_without_physipy_asst_per.'</td>
         <td align="center">'.$post_anaesthesia_scroing_sign_anaesthist.'</td>
        </tr>';
