	...
	<div class="col-lg-10" style="padding-left:0;">
		<table class="table table-bordered">
			<tr>
				...
				<?php
					$sql = mysqli_query($connect,"SELECT eqp_dtbr, eqp_dtrp FROM tbl_eqp_indic WHERE eqp_dtbr BETWEEN '$frdt' AND '$todt'")or die(mysqli_error($connect));
			...
			<tr>
				...
				<?php
					$sq2 = mysqli_query($connect,"SELECT * FROM tbl_eqp_mast WHERE (month(eqp_wty1) = '$month' OR month(eqp_wty1) < '$month' AND year(eqp_wty1) = '$yr' OR year(eqp_wty1) < '$yr') AND (month(eqp_wty2) > '$month' AND year(eqp_wty2) = '$yr' OR year(eqp_wty2) > '$yr')")or die(mysqli_error($connect));
