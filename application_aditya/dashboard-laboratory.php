    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu" >
            <ul class="list" >
                ...
                <li class="active open"><a href="dashboard-laboratory.php"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
               ...
               <!--  <li><a href="admin-kpi.php"><i class="zmdi zmdi-home"></i><span>K.P.I. - Front Office</span></a></li> -->                                               
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span style="color: #eee; font-size: 13.5px;">Quality Indicators</span> </a>
                    <ul class="ml-menu">
                        ...
                        <li style="background-color: #262626";><a href="#" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Laboratory Indicators</a></li>
                        <li><a href="lab_opd_form_LAB.php" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Laboratory Register (OPD)</a></li>
                        <li><a href="lab_ipd_form_LAB.php" style="color: #eee; font-size: 13.5px; line-height: 2.5;">Laboratory Register (IPD)</a></li><br>
...
<section class="content home">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Dashboard - Laboratory Officer </h2>
                                 ...
                                 <form method="post" enctype="multipart/form-data"  id="faq_lab">
                                        ...
                                        <div class="container" >
                                             ...
                                             <!--  <button style="background-color: #607D8B;" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">FAQ’S FOR FRONT OFFICE MANUAL</button> -->
                                               ...
                                               <button style="background-color: #607D8B;width: 320px;" type="button" class="btn btn-info btn-lg" class="show_faq_lab" id="show_faq_lab">FAQ’S FOR LABORATORY MANUAL</button>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                  ...
                                                  <div class="modal-content">
                                                    ...
                                                    <?php $id=1; foreach ($data_lab as $key => $value) { ?>
                                                       ...
                                                       <table id="showtab7" cellpadding="0" cellspacing="0" border="1" width="320" style=" text-align: center;border-color: 1px solid gray;">
