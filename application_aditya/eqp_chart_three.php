...
if(isset($_POST["frdate"],$_POST["todate"]))
{
	$data[] = array('Date','No of breakdowns' , 'Breakdown Time');
		...
		// main table
	$sq = "SELECT DISTINCT eqp_brkdwn_date FROM tbl_eqp_indic WHERE (eqp_brkdwn_date BETWEEN '".$_POST["frdate"]."' AND '".$_POST["todate"]."') ORDER BY eqp_brkdwn_date ASC";
