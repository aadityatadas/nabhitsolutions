							...
							<div id="adm">
								<form method="post" id="user_form" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Name (Optional)
नाव (पर्यायी)</label>
											<div class="col-lg-7">
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Age(वय)</label>
											<div class="col-lg-2">
										...
										<div class="col-lg-12">
											<label class="col-lg-4">E-mail ID(
ई - मेल आयडी)</label>
											<div class="col-lg-7">
...
पत्ता)</label>
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Treating Doctor(
डॉक्टर उपचार)</label>
											<div class="col-lg-7">
										...
										<div class="col-lg-12">
											<label class="col-lg-4">You Heard/Read about Hospital From(आपण हॉस्पिटल बद्दल ऐकले / वाचा)</label>
											<div class="col-lg-8">
												TV/Radio(
टीव्ही / रेडिओ)&nbsp;&nbsp;<input type="checkbox" value="TV/Radio" name="aj1" id="tvv" />
												&nbsp;Print Media/Hoarding(प्रिंट मीडिया / होर्डिंग)&nbsp;&nbsp;<input type="checkbox" value="Print Media/Hoarding" name="aj2" id="prtt" />
												&nbsp;Friend/Relatives(मित्र / नातेवाईक)&nbsp;&nbsp;<input type="checkbox" value="Friend/Relatives" name="aj3" id="medd" />
											</div>
										</div>
										<div class="col-lg-12">
											<br />
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Other (Please Specify)इतर (कृपया निर्दिष्ट करा)</label>
											<div class="col-lg-7">
										...
										<div class="col-lg-12">
											<div id="ord" class="table-responsive">
												<table class="table table-bordered table-hover">
													<thead>
														<tr>
															<th>Facilities / Services(सुविधा / सेवा)</th>
															<th>Extremely Dissatisfied(अत्यंत असमाधानी)</th>
															<th>Dissatisfied(
असमाधानी)</th>
															<th>Neither Satisfied / Nor dissatisfied(समाधानी / असंतुष्ट नाही)</th>
															<th>Satisfied(समाधानी)</th>
															<th>Extremely Satisfied(
अत्यंत समाधानी)</th>
														</tr>
													</thead>
													<tbody>
														<tr>
															<td>1) Reception Staff(स्वागत कर्मचारी)</td>
														...
														<tr>
															<td>2) Registration Process(नोंदणी प्रक्रिया)</td>
														...
														<tr>
															<td>3) O.P.D. Billing(ओ.पी.डी. बिलिंग)</td>
...
नर्सिंग कर्मचारी)</td>
														...
														<tr>
															<td>6) Consultant/Treating Doctor(सल्लागार / उपचार करणारे डॉक्टर)</td>
														...
														<tr>
															<td>7) Waiting Time to see the Doctor(डॉक्टर पाहण्यासाठी प्रतीक्षा वेळ)</td>
...
फिजियोथेरेपी)</td>
														...
														<tr>
															<td>11) Cleanliness & Hygeine(स्वच्छता आणि हायजिन)</td>
														...
														<tr>
															<td>12) Drinking Water Facilities(पाणी पिण्याची सुविधा)</td>
														...
														<tr>
															<td>13) Toilet Facility(शौचालय सुविधा)</td>
														...
														<tr>
															<td>15) Information & Sign Board(माहिती आणि साइन बोर्ड)</td>
														...
														<tr>
															<td>16) Parking Facility(पार्किंग सुविधा)</td>
														...
														<tr>
															<td>17) Security Staff(सुरक्षा कर्मचारी)</td>
										...
										<div class="col-lg-12">
											<label class="col-lg-4">Reason for Dissatisfaction with above services / Facilities(उपरोक्त सेवा / सुविधा असंतोष का कारण)</label>
											<div class="col-lg-7">
												<textarea type="text" col="3" name="mo8" id="mo8" class="form-control" ></textarea>
											</div>
										</div>
										<div class="col-lg-12">
											<label class="col-lg-4">Any other Suggestion / Complaints(
इतर कोणत्याही सूचना / तक्रारी)</label>
											<div class="col-lg-7">
