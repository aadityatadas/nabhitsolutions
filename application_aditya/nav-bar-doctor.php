                       ...
                       <!--<li>
                        ...
                        <li>
						 ...
						 <li style="border-bottom: 0px; ">
                            <a href="dashboard-doc.php" style="color:#999;"><i class="fa fa-home fa-fw"></i> <b> Doctor's Related Indicator</b> </a>
                        </li>

                         <li style="border-bottom: 0px; ">
                           <a href="int_asst_form1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Intial Assessment Time</a>
                         </li>

						<li style="border-bottom: 0px; ">
                            <a href="ipd_waittm_form1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> IPD Discharge Time </a>
                        </li>
					
						<li style="border-bottom: 0px; ">
                            <a href="blood_trasfusion_event1.php" style="color:#999;"><i class="glyphicon glyphicon-record"></i> Blood Trasfusion Events</a>
                        </li>
                                  
                          <!--  <a href="#"><i class="fa fa-home fa-fw"></i><b style="color:#0066cc;">  Nurse's Related Indicator</b> </a>
                        </li>
