<?php
	...
	$dArry[1] = array(0=>'Hasthe organization a procedure for specimen handling?');
	$dArry[2] = array(0=>'Have all staff handling / transporting specimens, including reception staff received appropriate training as specified in the procedure ?');
	$dArry[3] = array(0=>'Are patient provided with an appropriate specimen container if required to produce specimens at home / clinic ?');
	$dArry[4] = array(0=>'Are specimen container sealed in a designated plastic transit bags ?');
	$dArry[5] = array(0=>'Are specimens awaiting transit kept in a designated area away from the public and staff rest areas ?');
	$dArry[6] = array(0=>'Is there a designated specimen fridge available where required ?');
	$dArry[7] = array(0=>'Are specimen stored inadedicated refrigerator which is seprate to food, medicines and vaccines ?');
        ...
        <div id="page-wrapper">
                    ...
                    <div class="panel panel-primary">
		                    	 ...
		                    	 <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$tot= "SELECT COUNT(*) as total FROM tbl_audit_hh8 WHERE year(created) = '$yr'";
														...
														$qrycomp = "SELECT COUNT(*) as comp FROM tbl_audit_hh8 WHERE sign!='' AND year(created) = '$yr' ";
																$rescomp = mysqli_query($connect, $qrycomp);
																$rowcomp=mysqli_fetch_assoc($rescomp);
																// echo $rowcomp['comp'];
																											

														$qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_audit_hh8 WHERE sign='' AND year(created) = '$yr' ";
						...
						<div class="box" id="bx1">
							<div id="adm">
								...
								<div class="col-lg-12">
									<label class="col-md-12" style="color: #333; background-color: #9ac6eb!important; border-color: #9ac6eb!important; text-align: center; padding:10px;"> Transportation & Handling of Specimens</label>
									<div class="col-lg-12">
										<table class="table table-bordered">
													<thead>
														<tr>
															<th>sr.no</th>
															<th width="30%"><strong>Transportation & Handling of Specimens
															<th>Yes</th>
															<th>No</th>
															<th>NA</th>
															<th>Comment</th>
			...
			<textarea name="arrVal[<?= $n ?>][2]" rows="2" id="cmt<?= $n ?>" cols="40"></textarea></td>
                        ...
                        <div class="col-lg-12" style="text-align:center">
								<form method="post" action="audit_hh/hic8Pdf.php"  target="print_popup"  onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
									<div class="panel-heading">
										...
										<input type="hidden" name="tblname" value="tbl_audit_hh8">
