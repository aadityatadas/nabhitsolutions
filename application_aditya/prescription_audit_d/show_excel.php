...
foreach ($result as $key => $row) {
 ...
 if($mlc_count){
       ...
       $json['sign_of_doc'][] = [$monthName , (int)$sign_of_doc_per];
        ...
        $json['pre_by_auth_person'][] = [$monthName , (int)$pre_by_auth_person_per];
         $json['drug_name_clear'][] = [$monthName , (int)$drug_name_clear_per];
          $json['dose_corret'][] = [$monthName , (int)$dose_corret_per];
           $json['time_prescription'][] = [$monthName , (int)$time_prescription_per];
            $json['sign_of_auth'][] = [$monthName , (int)$sign_of_auth_per];
