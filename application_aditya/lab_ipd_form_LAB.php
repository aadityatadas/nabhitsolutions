...
<input type="hidden" name="lab_ipd_id_or" id="lab_ipd_id_or" />
                        ...
                        <div class="box" id="bx2">
							...
							<div class="col-lg-12">
								<div class="panel panel-default">
									...
									<form method="post" action="../excel/LAB-IPD/export.php" class="panel-heading">
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				...
				{  
					...
					/*$('#tddd').val(data.tddd);
					$('#mlc').val(data.mlc);*/
					$('#lab_ipd_id_or').val(data.lab_ipd_id);
...
html +='<div class="col-lg-12"><label class="col-lg-4">Name of LAB Personnel</label><div class="col-lg-7"><input type="text" autocomplete="off" name="Remarksold[]" id="Remarksold'+i+'" placeholder="name of LAB Personnel" class="form-control" value="'+data.Remarks_old[i]+'" readonly /></div></div>';
          ...
          html +='<div class="col-lg-4"></div><div class="col-lg-2"><button type="button" name="edit" id="'+data.lab_ipd_extra_id[i]+'"  class="btn btn-info edit_data">Edit Record No. '+j+'</button></div></div>';
...
<div id="add_data_Modal" class="modal fade">  
           ...
           <div class="modal-content">  
			...
			<div class="col-lg-12">
                    ...
                    <input type="hidden" name="user_idEdit" id="user_idEdit" />
                     <input type="hidden" name="lab_ipd_extra_id" id="lab_ipd_extra_id" />
 ...
 <script type="text/javascript">
 	...
 	$(document).on('click', '.edit_data', function(){ 
            ...
            var lab_ipd_extra_id = $(this).attr("id");
            var action = "view"; 
           
            
           $.ajax({  
                url:"fetch_single_lab_ipd_form_edit.php",  
                method:"POST",  
                data:{lab_ipd_extra_id:lab_ipd_extra_id,action:action},  
                dataType:"json",  
                success:function(data){ 
	...
	$('#dateofreportgenerationEdit').val(data.d_time_date_of_rep_genEdit);
					...
					$('#lab_ipd_extra_id').val(data.lab_ipd_extra_id); 

                     $('#user_idEdit').val(data.tbl_lab_lpd_id); 
