...
if(isset($_POST['chk1'])){
	...
	if($_POST['chk1']['qi']){
                 ...
                 foreach ($qi as $key => $value) {
                 	...
                 	$sql ="UPDATE tbl_faq_hr SET qi=1 , created_qi='$date' where pos=".$key;
                 ...
                 foreach ($result as $key => $value) {
                 	...
                 	$sql ="UPDATE tbl_faq_hr SET qi='' where pos=".$value;
	...
	if($_POST['chk1']['hr']){
                 ...
                 foreach ($hr as $key => $value) {
                 	...
                 	$sql ="UPDATE tbl_faq_hr SET hr=1 ,created_hr='$date'where pos=".$key;
                 ...
                 foreach ($result as $key => $value) {
                 	...
                 	$sql ="UPDATE tbl_faq_hr SET hr='' where pos=".$value;
