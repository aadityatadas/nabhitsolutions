<?php
	...
	$qry = "SELECT DISTINCT month_id FROM tbl_audit_hh14";
	...
	$dArry[1] = array(0=>'Hand hygiene is performed prior to preparing the feed and /or manipulation of the enteral feeding system');
	$dArry[2] = array(0=>'A non touch technique is used when connecting the giving set to the enteral
	tube');
	$dArry[3] = array(0=>'30mls of sterile water is used to flush the tube prior and post administration of drugs and following discontinuation of the feed  (unless contraindicated)');
	$dArry[4] = array(0=>'Sterile water is single patient use');
	$dArry[5] = array(0=>'The sterile water is labeled with patient details, the time and date opened
	and is discarded after 24 hrs');
	$dArry[6] = array(0=>'A sterile syringe is used each time water is withdrawn');
	$dArry[7] = array(0=>'Sterile ready to use feeds are used whenever possible');
	$dArry[8] = array(0=>'Single feeds that are not pre packaged are discontinued within four hours');
	$dArry[9] = array(0=>'The feeds is within expiry date');
	$dArry[10] = array(0=>'The feeds is labeled with patient details, the time and date opened.');
	$dArry[11] = array(0=>'Single use equipment including syringes are not reused');
	$dArry[12] = array(0=>'Aseptic technique is used along with sterile dressing for the care of the
	insertion site of PEGs for the first 48 hours');
	$dArry[13] = array(0=>'Is the ostomy feeding tube site washed daily and dried thoroughly?');
        ...
        <div id="page-wrapper">
                    ...
                    <div class="panel panel-primary">
		                    	 ...
		                    	 <table class="custom-table"  cellspacing="10" cellpadding="10" border="1" width="650px" align="center" style="border-color: #9DA2E2; text-align: center;" >
		                            		...
		                            		<tr style="background-color: white;">
		                            			<?php
													...
													$tot= "SELECT COUNT(*) as total FROM tbl_audit_hh14 WHERE year(created) = '$yr'";
														...
														$qrycomp = "SELECT COUNT(*) as comp FROM tbl_audit_hh14 WHERE sign!='' AND year(created) = '$yr' ";
																$rescomp = mysqli_query($connect, $qrycomp);
																$rowcomp=mysqli_fetch_assoc($rescomp);
																// echo $rowcomp['comp'];
																											

														$qrynotcomp = "SELECT COUNT(*) as notcomp FROM tbl_audit_hh14 WHERE sign='' AND year(created) = '$yr' ";
						...
						<div class="box" id="bx1">
							<div id="adm">
								...
								<div class="col-lg-12">
									<label class="col-md-12" style="color: #333; background-color: #9ac6eb!important; border-color: #9ac6eb!important; text-align: center; padding:10px;"> Enteral feeding </label>
									<div class="col-lg-12">
										<table class="table table-bordered">
													<thead>
														<tr>
															<th>sr.no</th>
															<th width="30%"><strong>Enteral feeding
															<th>Yes</th>
															<th>No</th>
															<th>NA</th>
															<th>Comment</th>
			...
			<textarea name="arrVal[<?= $n ?>][2]" rows="2" id="cmt<?= $n ?>" cols="40"></textarea></td>
										...
										<div class="col-lg-12">
											...
											<div class="col-lg-9">
												<input type="text" autocomplete="off" name="sign" id="sign" 
												 ...
												 <input type="hidden" name="tbl" value="tbl_audit_hh14">
											</div>
                        ...
                        <div class="col-lg-12" style="text-align:center">
								<form method="post" action="audit_hh/hic14Pdf.php"  target="print_popup"  onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
									<div class="panel-heading">
										...
										<input type="hidden" name="tblname" value="tbl_audit_hh14">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p style="text-align: center;"><b><font color="#000000">Enteral feeding</font></b></p>
 ...
 <script>
    	...
    	$(document).on('click', '#myModel', function(){
          ...
          //alert(uid);
            ...
            $.ajax({
                method:"POST",
				url: "audit_hh/hic14Excel.php",
				data:{user_id:uid,tbl:'tbl_audit_hh14',ptbl:'ptbl'},
                cache: false,
	...
	$(document).ready(function() {
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				...
				method:"POST",
				data:{user_id:user_id,tbl:'tbl_audit_hh14'},
				dataType:"json",
				success:function(data)
				{
					$('#bx1').show('fast');
