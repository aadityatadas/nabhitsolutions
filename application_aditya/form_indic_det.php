...
<!-- 	 <tr>
  ...
  -->
    ...
    <tr>
		<td  style="text-align:center; background-color: #e6eeff; font-weight: bold;font-size: 14px;">19</td>
		<td  style="font-weight: bold;font-size: 14px; font-family: sans-serif; background-color: #e6eeff;"> EMERGENCY REGISTER </td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr style="background-color:#ccebff;"><td><b>MONTHS</b></td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>1. Total No of Emergencies</td></tr>
				<tr style="font-size: 16px;"><td>2. Average Emergency Arival Time in hrs</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>3. No of Brought Dead</td></tr>
				<tr style="font-size: 16px;"><td>4. Total No of Return to Emergency Dep</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>5. % Return to Emergency Dep within 72hrs</td></tr>
    ...
    <td valign="top" colspan="13">
			...
			<tr>
					...
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo number_format($emercount,2);?></center></td>
					<?php
						}
					?>
				</tr>
...
<tr>
					...
					?>
					<td style=" font-size:16px;" id="ajj"><center><?php echo number_format(($avg_imgncy_arival_time/(60*60)),2); ?></center></td>
					<?php
						}
					?>
				</tr>
<tr>
					...
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo ($brought_dead);?></center></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					<?php
						for($month = 1; $month <= 12; $month ++){
							$qry6_emer = mysqli_query($connect,"SELECT COUNT(*) as back_to_emrgncy FROM tbl_emrgncy_register_ipd WHERE (month(date_of_patient_arrvl_at_emrgncy) = '$month' AND year(date_of_patient_arrvl_at_emrgncy) = '$yr') AND date_of_retrn_to_emrgncy_dept_if_any !=''")or die(mysqli_error($connect));

							$resEm6 = mysqli_fetch_assoc($qry6_emer);

	    				$back_to_emrgncy   = $resEm6['back_to_emrgncy'];
							
					?>
					<td style=" font-size:16px;" id="ajj"><center><?php echo ($back_to_emrgncy);?></center></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					<?php
						...
						for($month = 1; $month <= 12; $month ++){
							$qry7_emer = mysqli_query($connect,"SELECT COUNT(*) as back_to_emrgncy_72  FROM tbl_emrgncy_register_ipd WHERE (month(date_of_patient_arrvl_at_emrgncy) = '$month' AND year(date_of_patient_arrvl_at_emrgncy) = '$yr') AND retn_of_emrgncy NOT IN ('','no','No')")or die(mysqli_error($connect));

							$resEm7 = mysqli_fetch_assoc($qry7_emer);

	    				$back_to_emrgncy_72   = $resEm7['back_to_emrgncy_72'];

	    				$qry4_emer = mysqli_query($connect,"SELECT emrgncy_register_ipd_id FROM tbl_emrgncy_register_ipd WHERE (month(date_of_patient_arrvl_at_emrgncy) = '$month' AND year(date_of_patient_arrvl_at_emrgncy) = '$yr')")or die(mysqli_error($connect));
							$no_of_emer = mysqli_num_rows($qry4_emer);
	    				
	    				if($no_of_emer){
	    				$per_back_to_emrgncy_72= (($no_of_emer-$back_to_emrgncy_72)*100)/$no_of_emer;
	    			}else{
	    					$per_back_to_emrgncy_72 =0;
	    			}
							
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo number_format($per_back_to_emrgncy_72,2);?></center></td>
					<?php
						}
					?>
				</tr>
            ...
            <tr>
		<td  style="text-align:center;  font-weight: bold;font-size: 14px;">20</td>
		<td  style="font-weight: bold;font-size: 14px; font-family: sans-serif;"> ICU REGISTER </td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr style="background-color:#ccebff;"><td><b>MONTHS</b></td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>1. Total No of Patient Admitted In ICU</td></tr>
                    <tr style=" font-size:16px;"><td>2. Total No of Patient Transfer/Descharge from ICU	</td></tr>
                    <tr style="background-color: #e6eeff; font-size:16px;"><td>3. Total No of Patient Return to ICU in 48hrs</td></tr>
                    <tr style="font-size:16px;"><td>4. % of Patient Return to ICU in 48hrs</td></tr>
			</table>
		</td>
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				...
				$total_icu = $resICU1["total_icu"];
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo $total_icu;?></center></td>
					<?php
						}
					?>
				</tr>
	...
	$total_icu_dis = $resICU2["total_icu_dis"];		
					...
					?>
					<td style="  font-size:16px;" id="ajj"><center><?php echo $total_icu_dis;?></center></td>
					<?php
						}
					?>
				</tr>
	...
	$total_icu_return = $resICU3["total_icu_return"];		
					...
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo $total_icu_return;?></center></td>
					<?php
						}
					?>
				</tr>
	...
	$qryICU1 = mysqli_query($connect,"SELECT count(*) as total_icu FROM tbl_icu_register_ipd WHERE (month(date_of_admison_in_icu) = '$month' AND year(date_of_admison_in_icu) = '$yr') AND date_of_admison_in_icu !='' ")or die(mysqli_error($connect));
			...
			if($total_icu){
					...
					?>
					<td style=" font-size:16px;" id="ajj"><center><?php echo $per;?></center></td>
					<?php
						}
					?>
				</tr>
		...
		<tr>
		<td  style="text-align:center; background-color: #e6eeff; font-weight: bold;font-size: 14px;">21</td>
		<td  style="font-weight: bold;font-size: 14px; font-family: sans-serif; background-color: #e6eeff;"> LABORATORY INDICATOR </td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr style="background-color:#ccebff;"><td><b>MONTHS</b></td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>1. Total No. of test</td></tr>
				<tr style="font-size: 16px;"><td>2. Avrage Total No. of test</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>3. No. Critical Alerts</td></tr>
				<tr style="font-size: 16px;"><td>4. Average Critical Alerts Time</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>5. % Redos </td></tr>
				<tr style="font-size: 16px;"><td>6. % Reporting of Error</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>7. % Report Corelating with Clinical Diagnosis</td></tr>
			</table>
		</td>
    ...
    <td valign="top" colspan="13">
			...
			<tr>
					<?php
	    				...
	    				$tcount   = $reslod1['td'];
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo ($tcount);?></center></td>
					<?php
						}
					?>
				</tr>
	...
	while ($res = mysqli_fetch_array($qry1)) {
		$avgtot += strtotime($res['time_date_of_rep_gen']) - strtotime($res['sample_rec_time_date']) ;
					...
					?>
					<td style=" font-size:16px;" id="ajj"><center><?php echo number_format($avgtot / 3600, 2);?></center></td>
					<?php
						}
					?>
				</tr>
	...
	$cri_count = mysqli_num_rows($qry2_lopd);
					...
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo number_format($cri_count);?></center></td>
					<?php
						}
					?>
				</tr>
	...
	while ($res = mysqli_fetch_array($qry2)) {
		$avgcri += strtotime($res['info_time']) - strtotime($res['result_time']) ;
					...
					?>
					<td style=" font-size:16px;" id="ajj"><center><?php echo number_format($avgcri / 3600, 2);?></center></td>
					<?php
						}
					?>
				</tr>
    ...
    $perredo = is_nan($perredo)? 0 : $perredo;
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo number_format($perredo,2);?></center></td>
					<?php
						}
					?>
				</tr>
	...
	$pererror = is_nan($pererror)? 0 : $pererror;
					?>
					<td style=" font-size:16px;" id="ajj"><center><?php echo number_format($pererror,2);?></center></td>
					<?php
						}
					?>
				</tr>
	...
	$perclinical = is_nan($perclinical)? 0 : $perclinical;
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo number_format($perclinical,2);?></center></td>
					<?php
						}
					?>
				</tr>
    ...
    <tr>
		<td  style="text-align:center;  font-weight: bold;font-size: 14px;">22</td>
		<td  style="font-weight: bold;font-size: 14px; font-family: sans-serif;"> PHARMACY REGISTRATION </td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr style="background-color:#ccebff;"><td><b>MONTHS</b></td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>1. Total no of Pharmacy Registration</td></tr>
				<tr style="font-size: 16px;"><td>2. Total No. of Item Purchases</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>3. Total No. of Sold Items</td></tr>
				<tr style="font-size: 16px;"><td>4. No. Of Stock Outs</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>5. % Of Stock Outs</td></tr>
				<tr style="font-size: 16px;"><td>6. Total Quantity Rejected </td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>7. Total Quantity Received Before Grn</td></tr>
				<tr style="font-size: 16px;"><td>8. Total No. Of Medication Error</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>9. % Of Medication Error</td></tr>
		...
		<td valign="top" colspan="13">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				...
				$total_reg = $resPhar["total_reg"];
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo $total_reg;?></center></td>
					<?php
						}
					?>
				</tr>
				...
				<tr>
					...
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center>0</center>
					</td>
					<?php
						}
					?>
		 ...
		 <tr>
		<td  style="text-align:center; background-color: #e6eeff; font-weight: bold;font-size: 14px;">23</td>
		<td  style="font-weight: bold;font-size: 14px; font-family: sans-serif; background-color: #e6eeff;"> RADIOLOGY INDICATOR (IPD) </td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr style="background-color:#ccebff;"><td><b>MONTHS</b></td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>1. Total no of Radiology Indicator  </td></tr>
				<tr style="font-size: 16px;"><td>2. Total No. of Test</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>3. Average (TAT Turn around Time)  </td></tr>
				<tr style="font-size: 16px;"><td>4. No. Critical Alerts</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>5. Average Critical Alerts Time  </td></tr>
				<tr style="font-size: 16px;"><td>6. % Redos</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>7. % Reporting of Error  </td></tr>
				<tr style="font-size: 16px;"><td>8. % Redos</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>9. % Report Corelating with Clinical Diagnosis  </td></tr>
    ...
    <td valign="top" colspan="13">
			...
			<tr>
				...
				$total_ripd1 = $resRIPD1["total_ripd1"];
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo $total_ripd + $total_ripd1;?></center></td>
					<?php
						}
					?>
				</tr>
...
<tr>
		<td  style="text-align:center; background-color: #e6eeff; font-weight: bold;font-size: 14px;">23</td>
		<td  style="font-weight: bold;font-size: 14px; font-family: sans-serif; background-color: #e6eeff;"> RADIOLOGY INDICATOR (OPD) </td>
		<td valign="top">
			<table width="100%" style="font-size:14px;" class="table-bordered">
				<tr style="background-color:#ccebff;"><td><b>MONTHS</b></td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>1. Total no of Radiology Indicator  </td></tr>
				...
				<tr style="background-color: #e6eeff; font-size:16px;"><td>7. % Reporting of Error  </td></tr>
				<tr style="font-size: 16px;"><td>8. % Redos</td></tr>
				<tr style="background-color: #e6eeff; font-size:16px;"><td>9. % Report Corelating with Clinical Diagnosis  </td>
    ...
    <td valign="top" colspan="13">
			...
			<tr>
				...
				$total_ropd1 = $resROPD1["total_ropd1"];
					?>
					<td style="background-color: #e6eeff; font-size:16px;" id="ajj"><center><?php echo $total_ropd + $total_ropd1;?></center></td>
					<?php
						}
					?>
				</tr>
